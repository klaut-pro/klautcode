...
Generates UPCOMING_CHANGELOG.md by running the klautcode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for klautcode run (default: low)
      --quiet            Suppress klautcode command output unless it fails
