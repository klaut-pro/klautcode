...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/klaut-pro/klautcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for klaut-pro/klautcode...\n")
...
console.log("Fetching npm all-time downloads for klautcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("klautcode-ai")
