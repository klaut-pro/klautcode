...
npm i -g klautcode-ai@latest        # o bun/pnpm/yarn
scoop install klautcode             # Windows
choco install klautcode             # Windows
brew install klaut-pro/tap/klautcode # macOS y Linux (recomendado, siempre al día)
brew install klautcode              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S klautcode            # Arch Linux (Stable)
paru -S klautcode-bin               # Arch Linux (Latest from AUR)
mise use -g klautcode               # cualquier sistema
nix run nixpkgs#klautcode           # o github:klaut-pro/klautcode para la rama dev más reciente
```
...
Klautcode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/klaut-pro/klautcode/releases) o desde [code.klaut.pro/download](https://code.klaut.pro/download).
...
1. `$KLAUTCODE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.klautcode/bin` - Alternativa por defecto
...
Klautcode incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://code.klaut.pro/docs/agents).

### Documentación

Para más información sobre cómo configurar Klautcode, [**ve a nuestra documentación**](https://code.klaut.pro/docs).

### Contribuir

Si te interesa contribuir a Klautcode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Klautcode

Si estás trabajando en un proyecto basado en Klautcode y usas "klautcode" como parte del nombre, por ejemplo, "klautcode-dashboard" u "klautcode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Klautcode y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/klautcode) | [X.com](https://x.com/klautcode)
