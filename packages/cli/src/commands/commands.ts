...
declare const KLAUTCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof KLAUTCODE_CLI_NAME === "string" ? KLAUTCODE_CLI_NAME : "klautcode", {
  description: "Klautcode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
