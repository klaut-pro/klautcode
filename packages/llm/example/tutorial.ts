...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@klautcode/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@klautcode/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-klautcode-tutorial": "1" },
    query: { debug: "1" },
  },
})
