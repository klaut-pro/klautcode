...
Schema-first LLM core for klautcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@klautcode/llm"
import { OpenAI } from "@klautcode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@klautcode/llm/providers"
