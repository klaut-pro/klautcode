...
const releaseId = process.env.KLAUTCODE_RELEASE
if (!releaseId) throw new Error("KLAUTCODE_RELEASE is required")

const version = process.env.KLAUTCODE_VERSION
if (!version) throw new Error("KLAUTCODE_VERSION is required")
...
const macxTarGz = "klautcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "klautcode-desktop-mac-arm64.app.tar.gz"
