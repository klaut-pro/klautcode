export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Klautcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Klautcode je bila prenesena, jo želite namestiti in znova zagnati?",
  ...
  "desktop.cli.installed.message":
    "CLI je nameščen v {{path}}\n\nZnova zaženite terminal, da lahko uporabite ukaz 'klautcode'.",
