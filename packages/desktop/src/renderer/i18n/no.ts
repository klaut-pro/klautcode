export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Klautcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Klautcode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert i {{path}}\n\nStart terminalen på nytt for å bruke 'klautcode'-kommandoen.",
