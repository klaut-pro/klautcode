export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Klautcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} Klautcode bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
  ...
  "desktop.cli.installed.message":
    "CLI bolo nainštalované do {{path}}\n\nReštartujte terminál, aby ste mohli používať príkaz 'klautcode'.",
