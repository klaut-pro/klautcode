export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Klautcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Klautcode a fost descărcată. Vrei să o instalezi și să repornești?",
  ...
  "desktop.cli.installed.message":
    "CLI a fost instalat în {{path}}\n\nRepornește terminalul pentru a folosi comanda 'klautcode'.",
