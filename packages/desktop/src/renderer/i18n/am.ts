export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የKlautcode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከKlautcode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
