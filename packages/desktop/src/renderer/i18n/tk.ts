export const dict = {
  ...
  "desktop.updater.none.message": "Klautcode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Klautcode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'klautcode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
