export const dict = {
  ...
  "desktop.updater.none.message": "Klautcode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Klautcode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'klautcode' komutunu kullanmak için terminalinizi yeniden başlatın.",
