export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Klautcoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Klautcoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Klautcoden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'klautcode'-komentoa.",
