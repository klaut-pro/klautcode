export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Klautcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Klautcode har laddats ned. Vill du installera den och starta om programmet?",
  ...
  "desktop.cli.installed.message":
    "CLI installerat i {{path}}\n\nStarta om terminalen för att använda kommandot 'klautcode'.",
