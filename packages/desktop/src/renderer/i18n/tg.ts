export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини Klautcode-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз Klautcode зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",
  ...
  "desktop.cli.installed.message":
    "CLI ба {{path}} насб карда шудааст\n\nБарои истифодаи фармони 'klautcode' терминали худро аз нав оғоз кунед.",
