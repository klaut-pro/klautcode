export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Klautcode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Klautcodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'klautcode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
