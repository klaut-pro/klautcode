export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Klautcode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Klautcode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „klautcode” kasutamiseks taaskäivitage terminal.",
