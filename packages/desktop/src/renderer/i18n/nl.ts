export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Klautcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Klautcode is gedownload. Wil je deze installeren en Klautcode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'klautcode' te gebruiken.",
