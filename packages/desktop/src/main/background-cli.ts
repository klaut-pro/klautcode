...
const desktopStateNames = ["ai.klautcode.desktop.dev", "ai.klautcode.desktop.beta", "ai.klautcode.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "klautcode-cli.exe" : "klautcode-cli"
}
