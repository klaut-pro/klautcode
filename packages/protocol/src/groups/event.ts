...
import type { Definition } from "@klautcode/schema/event"
...
export const KlautcodeEvent = event.schema
export type KlautcodeEvent = typeof KlautcodeEvent.Type
export type KlautcodeEventEncoded = typeof KlautcodeEvent.Encoded
