import { Klautcode } from "@klautcode/client/effect"
...
import { createEmbeddedRoutes } from "@klautcode/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Klautcode.create")(function* () {
  ...
  const client = yield* Klautcode.make({ baseUrl: "http://klautcode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/sdk-next/Klautcode") {}
