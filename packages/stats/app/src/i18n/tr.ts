export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Klautcode Data",
  "app.description":
    "Klautcode Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Klautcode Data logosu",
  ...
  "header.githubAria": "GitHub'da Klautcode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryKlautcode": "Klautcode'u dene",
  ...
  "footer.homeAria": "Klautcode ana sayfası",
  ...
  "home.topModelsDescription": "Klautcode Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Klautcode Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Klautcode Data",
  "lab.description":
    "Klautcode Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Klautcode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Klautcode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Klautcode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Klautcode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Klautcode Data",
  "model.description":
    "{{model}} için Klautcode Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Klautcode Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Klautcode Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Klautcode Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Klautcode Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Klautcode Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Klautcode Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Klautcode Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Klautcode Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Klautcode Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Klautcode Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Klautcode Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Klautcode Go token hacmine göre yakındaki modeller.",
