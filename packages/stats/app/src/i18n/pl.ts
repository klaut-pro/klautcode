export const dict = {
  "app.title": "Rankingi użycia modeli AI | Klautcode Data",
  "app.description":
    "Przeglądaj użycie Klautcode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Klautcode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Klautcode na GitHub",
  "header.github": "GitHub",
  "header.tryKlautcode": "Wypróbuj Klautcode",
  ...
  "footer.homeAria": "Strona główna Klautcode",
  ...
  "home.topModelsDescription": "Użycie modeli w Klautcode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Klautcode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Klautcode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Klautcode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Klautcode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Klautcode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Klautcode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Klautcode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Klautcode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Klautcode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Klautcode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Klautcode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Klautcode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Klautcode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Klautcode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Klautcode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Klautcode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Klautcode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Klautcode Go.",
  ...
  "model.geoDescription": "Tokeny modelu Klautcode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Klautcode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Klautcode Go.",
