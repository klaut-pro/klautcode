import klautcodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/klautcode",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "klautcode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://code.klaut.pro/">
            <strong>{i18n.t("header.tryKlautcode")}</strong>
          </a>
          <button
...
function KlautcodeMark() {
  return (
    <svg data-slot="klautcode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://code.klaut.pro/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://code.klaut.pro/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@code.klaut.pro", label: i18n.t("footer.contact") },
    { href: "https://code.klaut.pro/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/klautcode", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://code.klaut.pro" aria-label={i18n.t("footer.homeAria")}>
          <KlautcodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={klautcodeWordmarkDark} alt="Klautcode" />
          <button
