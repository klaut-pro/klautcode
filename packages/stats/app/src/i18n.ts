...
const en = {
  "app.title": "AI Model Usage Rankings | Klautcode Data",
  "app.description":
    "Explore Klautcode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Klautcode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Klautcode on GitHub",
  "header.github": "GitHub",
  "header.tryKlautcode": "Try Klautcode",
  ...
  "footer.homeAria": "Klautcode home",
  ...
  "home.topModelsDescription": "Usage of models across Klautcode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Klautcode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Klautcode Data",
  "lab.description":
    "Compare {{lab}} models used in Klautcode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Klautcode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Klautcode",
  ...
  "lab.shareOfUsage": "{{share}} of recent Klautcode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Klautcode Data",
  "model.description":
    "View {{model}} Klautcode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Klautcode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Klautcode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Klautcode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Klautcode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Klautcode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Klautcode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Klautcode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Klautcode Go token volume.",
