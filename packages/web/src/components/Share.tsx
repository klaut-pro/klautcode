...
import { IconKlautcode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "klautcode/session/message-v2"
import type { Message } from "klautcode/session/message"
import type { Session } from "klautcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.klautcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.klautcode_name}>
                    <IconKlautcode width={16} height={16} />
                  </div>
