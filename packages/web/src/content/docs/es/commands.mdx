...
Crear `.klautcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Klautcode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Klautcode [config](/docs/config):
...
- Por proyecto: `.klautcode/commands/`
...
klautcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
