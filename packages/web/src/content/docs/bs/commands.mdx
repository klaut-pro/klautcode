...
Kreiraj `.klautcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Klautcode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Klautcode [config](/docs/config):
...
- Globalno: `~/.config/klautcode/commands/`
- Po projektu: `.klautcode/commands/`
...
Klautcode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
