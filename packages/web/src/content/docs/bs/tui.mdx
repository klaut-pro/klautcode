---
title: TUI
description: Korištenje korisničkog interfejsa Klautcode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Klautcode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Klautcode pokreće TUI za trenutni direktorij.
...
Kada koristite Klautcode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Klautcode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Klautcode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `klautcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Klautcode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `klautcode.default`.
