---
title: Paylasim
description: klautcode konusmalarini genel baglantilarla paylasin.
---

klautcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda klautcode:
...
klautcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak klautcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `klautcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda klautcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
