---
title: Özel Araçlar
description: LLM'un klautcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. klautcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.klautcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/klautcode/tools/` içine yerleştirerek.
