...
`.klautcode/commands/test.md` oluştur:
...
klautcode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

klautcode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/klautcode/commands/`
- Proje başına: `.klautcode/commands/`
...
klautcode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
