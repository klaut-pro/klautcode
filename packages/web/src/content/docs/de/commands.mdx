...
Erstellen Sie `.klautcode/commands/test.md`:

```md title=".klautcode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Klautcode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Klautcode [config](/docs/config):

```json title="klautcode.jsonc" {4-12}
{
...
- Global: `~/.config/klautcode/commands/`
- Pro Projekt: `.klautcode/commands/`

```markdown title="~/.config/klautcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".klautcode/commands/component.md"
---
...
```md title=".klautcode/commands/create-file.md"
---
...
```md title=".klautcode/commands/analyze-coverage.md"
---
...
```md title=".klautcode/commands/review-changes.md"
---
...
```md title=".klautcode/commands/review-component.md"
---
...
Klautcode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
