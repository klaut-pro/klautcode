---
title: Teilen
description: Teile Klautcode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Klautcode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Klautcode Folgendes:
...
Klautcode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Klautcode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`klautcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du klautcode in deiner Organisation einsetzt.
