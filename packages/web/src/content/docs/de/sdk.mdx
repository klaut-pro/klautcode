---
title: SDK
description: Typsicherer JS-Client fuer den klautcode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das klautcode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und klautcode programmatisch steuern.
...
Erstelle eine klautcode-Instanz:
...
`klautcode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn klautcode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
