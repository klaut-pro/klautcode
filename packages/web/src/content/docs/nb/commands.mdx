...
Opprett `.klautcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Klautcode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Klautcode [config](/docs/config):
...
- Per prosjekt: `.klautcode/commands/`
...
Klautcode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
