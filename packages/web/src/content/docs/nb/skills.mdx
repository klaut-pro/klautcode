...
Agentferdigheter lar Klautcode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går klautcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
klautcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `klautcode.json`:
