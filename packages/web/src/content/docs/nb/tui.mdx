---
title: TUI
description: Bruke klautcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Klautcode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Klautcode starter TUI for gjeldende katalog.
...
Når du bruker Klautcode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Klautcode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Klautcode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `klautcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Klautcode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `klautcode.default`.
