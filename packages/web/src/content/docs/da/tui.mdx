---
title: TUI
description: Brug af Klautcode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Klautcode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Klautcode starter TUI for den nuværende mappe.
...
Når du bruger Klautcode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Klautcode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Klautcode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `klautcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Klautcode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `klautcode.default`.
