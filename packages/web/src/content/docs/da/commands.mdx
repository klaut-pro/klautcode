...
Opret `.klautcode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Klautcode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Klautcode [config](/docs/config):
...
- Globalt: `~/.config/klautcode/commands/`
- Pr. projekt: `.klautcode/commands/`
...
klautcode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
