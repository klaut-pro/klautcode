...
Brug den til at bygge integrasjoner og kontrollere klautcode programmatisk.
...
Opret en forekomst av klautcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `klautcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av klautcode, kan du oprete en klientforekomst for at koble til den:
