...
สร้าง `.klautcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Klautcode:
...
- ระดับผู้ใช้ (Global): `~/.config/klautcode/commands/`
- ระดับโปรเจ็กต์: `.klautcode/commands/`
...
Klautcode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
