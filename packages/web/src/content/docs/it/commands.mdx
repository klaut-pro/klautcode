...
Crea `.klautcode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Klautcode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Klautcode:
...
- Globale: `~/.config/klautcode/commands/`
- Per progetto: `.klautcode/commands/`
...
klautcode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
