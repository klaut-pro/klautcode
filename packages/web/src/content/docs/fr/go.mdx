...
L'[ID de modèle](/docs/config/#models) dans votre configuration Klautcode utilise le format `opencode-go/<model-id>`. Par exemple, pour Kimi K3, vous utiliseriez `opencode-go/kimi-k3` dans votre configuration.
