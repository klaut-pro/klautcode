...
Utwórz `.klautcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `klautcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji klautcode:
...
- Globalnie: `~/.config/klautcode/commands/`
- Na projekt: `.klautcode/commands/`
...
klautcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
