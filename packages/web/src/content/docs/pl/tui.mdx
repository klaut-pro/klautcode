---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala klautcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

klautcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie klautcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI klautcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do klautcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij klautcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `klautcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Klautcode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `klautcode.default`.
