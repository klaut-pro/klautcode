...
export const TypeId: TypeId = "~@klautcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@klautcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@klautcode/effect-sqlite-node/NodeSqliteClient")
