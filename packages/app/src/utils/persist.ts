...
const GLOBAL_STORAGE = "klautcode.global.dat"
const WINDOW_STORAGE = "klautcode.window"
const LOCAL_PREFIX = "klautcode."
...
function workspaceStorage(dir: string) {
  ...
  return `klautcode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `klautcode.draft.${head}.${sum}.dat`
}
