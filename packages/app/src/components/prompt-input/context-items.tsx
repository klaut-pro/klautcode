...
import { getDirectory, getFilename, getFilenameTruncated } from "@klautcode/core/util/path"
              ...
              >
                ...
                >
                  <div class="flex items-center gap-1.5">
                    ...
                    <div class="flex items-center text-(--font-size-small) min-w-0 font-medium leading-5">
