...
beforeAll(async () => {
  ...
  mock.module("@klautcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@klautcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@klautcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@klautcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
