import { useFilteredList } from "@klautcode/ui/hooks"
import { useSpring } from "@klautcode/ui/motion-spring"
import {
  createEffect,
  on,
  Component,
...
import { DockShellForm, DockTray } from "@klautcode/ui/dock-surface"
    ...
    if (stopping()) {
      return (
        <div class="flex items-center gap-2">
          ...
          <span class="text-icon-base text-12-medium text-[calc(10px*var(--font-size-scale))]!">{language.t("common.key.esc")}</span>
        </div>
      )
    }
