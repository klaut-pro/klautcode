...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Klautcode se nije uspio učitati",
  "Prozor aplikacije Klautcode neočekivano je zatvoren",
  "Klautcode ne reagira",
  ...
  "Instalacija aplikacije Klautcode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "klautcode nije instaliran u ovoj distribuciji",
  "klautcode je instaliran, ali se ne može pokrenuti",
  "Klautcode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Klautcode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.klautcode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.klautcode.tagline": "Pouzdani optimizirani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Posjetiti",
  "provider.connect.klautcodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.klautcodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Klautcode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u klautcode.json",
  ...
  "dialog.server.description": "Promijenite na koji se Klautcode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingKlautcodeIn": "Provjera Klautcode u {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Ažuriranje Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Ažuriranje Klautcode u {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Ažurirajte Klautcode u {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Ažurirajte Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode je spreman u {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode je spreman.",
  "wsl.onboarding.installKlautcodeIn": "Instalirajte Klautcode u {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instalirajte Klautcode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Klautcode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Klautcode.",
  ...
  "help.tabs.introduction": "Radna površina Klautcode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Klautcode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Klautcode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (klautcode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Klautcode još ne podržava MCP autentifikaciju.',
  ...
  "session.title.regenerate": "Ponovno generiraj naslov",
  "session.title.regenerated": "Naslov ponovno generiran",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Klautcode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Klautcode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Klautcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Klautcode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Klautcode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Klautcode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Klautcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Klautcode.",
