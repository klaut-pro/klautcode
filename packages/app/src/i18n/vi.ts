export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Klautcode",
  ...
  "desktop.recovery.loadFailed": "Không tải được Klautcode",
  "desktop.recovery.terminated": "Cửa sổ Klautcode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Klautcode không phản hồi",
  ...
  "desktop.wsl.error.installKlautcode": "Không cài đặt được Klautcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.klautcodeMissing": "klautcode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Klautcode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.klautcode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Klautcode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Truy cập ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Klautcode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong klautcode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Klautcode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingKlautcode": "Đang kiểm tra Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Đang kiểm tra Klautcode trong {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Đang cập nhật Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Đang cập nhật Klautcode trong {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Cập nhật Klautcode trong {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Cập nhật Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode đã sẵn sàng.",
  "wsl.onboarding.installKlautcodeIn": "Cài đặt Klautcode trong {{distro}}.",
  "wsl.onboarding.installKlautcode": "Cài đặt Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Klautcode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Klautcode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Klautcode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Klautcode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (klautcode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Klautcode chưa hỗ trợ xác thực MCP.',
  ...
  "session.followupDock.delete": "Xóa",
  ...
  "session.title.regenerate": "Tạo lại tiêu đề",
  "session.title.regenerated": "Đã tạo lại tiêu đề",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Klautcode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Klautcode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Klautcode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Klautcode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Klautcode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Klautcode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Klautcode.",
  "settings.updates.toast.missingArtifacts": "Bản phát hành mới nhất chưa có bản cập nhật cho nền tảng này.",
