export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode-documentatie",
  ...
  "desktop.recovery.loadFailed": "Klautcode kan niet worden geladen",
  "desktop.recovery.terminated": "Het Klautcode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Klautcode reageert niet",
  ...
  "desktop.wsl.error.installKlautcode": "Installatie van Klautcode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.klautcodeMissing": "klautcode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Klautcode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.klautcode.tagline": "Betrouwbare geoptimaliseerde modellen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Klautcode te gebruiken.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.klautcodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.klautcodeZen.visit.prefix": "Ga naar ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Klautcode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Klautcode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in klautcode.json",
  ...
  "dialog.server.description": "Wijzig met welke Klautcode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode controleren...",
  "wsl.onboarding.checkingKlautcodeIn": "Klautcode controleren in {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Klautcode bijwerken...",
  "wsl.onboarding.updatingKlautcodeIn": "Klautcode bijwerken in {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Werk Klautcode bij in {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Klautcode bijwerken",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode is gereed in {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode is klaar.",
  "wsl.onboarding.installKlautcodeIn": "Installeer Klautcode in {{distro}}.",
  "wsl.onboarding.installKlautcode": "Installeer Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Klautcode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Klautcode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Klautcode opnieuw.",
  ...
  "help.tabs.introduction": "Klautcode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Klautcode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Klautcode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (klautcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Klautcode ondersteunt nog geen MCP-authenticatie.',
  ...
  "session.followupDock.delete": "Verwijderen",
  ...
  "session.title.regenerate": "Titel opnieuw genereren",
  "session.title.regenerated": "Titel opnieuw gegenereerd",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Klautcode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Klautcode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Klautcode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Klautcode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Klautcode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Klautcode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Klautcode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Klautcode.",
  "settings.updates.toast.missingArtifacts": "De nieuwste release heeft nog geen update voor dit platform.",
