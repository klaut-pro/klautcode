export const dict = {
  ...
  "dialog.provider.klautcode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.klautcode.tagline": "Luotettavat optimoidut mallit",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Klautcodessa.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Avaa ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Klautcodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Klautcodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään klautcode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Klautcode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingKlautcode": "Tarkistetaan Klautcodea...",
  "wsl.onboarding.checkingKlautcodeIn": "Tarkistetaan Klautcodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Päivitetään Klautcodea...",
  "wsl.onboarding.updatingKlautcodeIn": "Päivitetään Klautcodea kohteessa {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Päivitä Klautcode jakelussa {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Päivitä Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode on valmis.",
  "wsl.onboarding.installKlautcodeIn": "Asenna Klautcode jakeluun {{distro}}.",
  "wsl.onboarding.installKlautcode": "Asenna Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Klautcode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Klautcode uudelleen.",
  ...
  "toast.update.description": "Klautcoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Klautcode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (klautcode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Klautcode ei vielä tue MCP-todennusta.',
  ...
  "session.followupDock.delete": "Poista",
  ...
  "session.title.regenerate": "Luo otsikko uudelleen",
  "session.title.regenerated": "Otsikko luotu uudelleen",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Klautcode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Klautcoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Klautcode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Klautcode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Klautcoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Klautcode käynnistyy",
  ...
  "desktop.menu.documentation": "Klautcode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Klautcode-valikko",
  ...
  "desktop.recovery.loadFailed": "Klautcoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Klautcode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Klautcode ei vastaa",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.klautcodeMissing": "klautcodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Klautcode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
