export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Klautcode ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Klautcode หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Klautcode ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installKlautcode": "การติดตั้ง Klautcode ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.klautcodeMissing": "ไม่ได้ติดตั้ง klautcode ในดิสโทรนี้",
  "desktop.wsl.error.klautcodeCannotRun": "ติดตั้ง klautcode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.klautcodeNotInstalled": "ไม่ได้ติดตั้ง Klautcode ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Klautcode เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "agent.mode.multitask": "มัลติทาสก์",
  ...
  "dialog.provider.klautcode.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.klautcode.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Klautcode",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Klautcode",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.klautcodeZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.klautcodeZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Klautcode",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Klautcode",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน klautcode.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Klautcode ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingKlautcode": "กำลังตรวจสอบ Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "กำลังตรวจสอบ Klautcode ใน {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "กำลังอัปเดต Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "กำลังอัปเดต Klautcode ใน {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "อัปเดต Klautcode ใน {{distro}}",
  "wsl.onboarding.updateKlautcode": "อัปเดต Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.klautcodeReady": "Klautcode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installKlautcodeIn": "ติดตั้ง Klautcode ใน {{distro}}",
  "wsl.onboarding.installKlautcode": "ติดตั้ง Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "ยังไม่ได้ติดตั้ง Klautcode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Klautcode จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Klautcode อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Klautcode Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Klautcode ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Klautcode",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (klautcode.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Klautcode ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "session.title.regenerate": "สร้างชื่อใหม่",
  "session.title.regenerated": "สร้างชื่อใหม่แล้ว",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Klautcode ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Klautcode",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Klautcode บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Klautcode ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Klautcode",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Klautcode เปิดใช้งาน",
