...
export const dict = {
  ...
  "dialog.provider.klautcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.klautcode.tagline": "Zuverlässige, optimierte Modelle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Klautcode zu nutzen.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Klautcode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Klautcode zu nutzen.",
  ...
  "dialog.plugins.empty": "In klautcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Klautcode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode wird geprüft…",
  "wsl.onboarding.checkingKlautcodeIn": "Klautcode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingKlautcode": "Klautcode wird aktualisiert…",
  "wsl.onboarding.updatingKlautcodeIn": "Klautcode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateKlautcodeIn": "Aktualisieren Sie Klautcode in {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Klautcode aktualisieren",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode ist in {{distro}} bereit.",
  "wsl.onboarding.klautcodeReady": "Klautcode ist bereit.",
  "wsl.onboarding.installKlautcodeIn": "Installieren Sie Klautcode in {{distro}}.",
  "wsl.onboarding.installKlautcode": "Klautcode installieren",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Klautcode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Klautcode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Klautcode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Klautcode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Klautcode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (klautcode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Klautcode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Klautcode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "session.title.regenerate": "Titel neu generieren",
  "session.title.regenerated": "Titel neu generiert",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Klautcode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Klautcode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Klautcode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Klautcode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Klautcode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Klautcode automatisch nach Updates suchen",
  ...
  "desktop.recovery.loadFailed": "Klautcode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Klautcode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Klautcode reagiert nicht",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.klautcodeMissing": "klautcode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Klautcode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Klautcode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
