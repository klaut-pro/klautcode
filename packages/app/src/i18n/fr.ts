export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Klautcode",
  ...
  "desktop.menu.ariaLabel": "Menu Klautcode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Klautcode",
  "desktop.recovery.terminated": "La fenêtre Klautcode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Klautcode ne répond pas",
  ...
  "desktop.wsl.error.installKlautcode": "Échec de l'installation d'Klautcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.klautcodeMissing": "klautcode n'est pas installé dans cette distribution",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Klautcode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "agent.mode.multitask": "multitâche",
  ...
  "dialog.provider.klautcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.klautcode.tagline": "Modèles optimisés et fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Visitez ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Klautcode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans klautcode.json",
  ...
  "mcp.auth.needsAuthentication": "Le serveur MCP {{name}} nécessite une authentification",
  "mcp.auth.authenticate": "S'authentifier",
  ...
  "dialog.server.description": "Changez le serveur Klautcode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingKlautcode": "Vérification d'Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Vérification d'Klautcode dans {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Mise à jour d'Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Mise à jour d'Klautcode dans {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Mettez à jour Klautcode dans {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Mettre à jour Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode est prêt dans {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode est prêt.",
  "wsl.onboarding.installKlautcodeIn": "Installez Klautcode dans {{distro}}.",
  "wsl.onboarding.installKlautcode": "Installer Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Klautcode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Klautcode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Klautcode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Klautcode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (klautcode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Klautcode ne prend pas encore en charge l'authentification MCP.",
  ...
  "session.title.regenerate": "Régénérer le titre",
  "session.title.regenerated": "Titre régénéré",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1":
    "Klautcode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Klautcode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Klautcode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Klautcode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Klautcode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Klautcode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Klautcode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Klautcode.",
  "settings.updates.toast.missingArtifacts": "La dernière version ne propose pas encore de mise à jour pour cette plateforme.",
