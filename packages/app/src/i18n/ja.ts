export const dict = {
  ...
  "desktop.recovery.loadFailed": "Klautcodeを読み込めませんでした",
  "desktop.recovery.terminated": "Klautcodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Klautcodeが応答していません",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.klautcodeMissing": "このディストリビューションにはklautcodeがインストールされていません",
  "desktop.wsl.error.klautcodeCannotRun": "klautcodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.klautcodeNotInstalled": "{{distro}}にはKlautcodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Klautcodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.klautcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.klautcode.tagline": "信頼性の高い最適化モデル",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Klautcodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.klautcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.klautcodeZen.visit.prefix": " ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKlautcodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Klautcodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "klautcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するKlautcodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcodeを確認中...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}}内のKlautcodeを確認中...",
  "wsl.onboarding.updatingKlautcode": "Klautcodeを更新中...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}}内のKlautcodeを更新中...",
  "wsl.onboarding.updateKlautcodeIn": "{{distro}}内のKlautcodeを更新してください。",
  "wsl.onboarding.updateKlautcode": "Klautcodeを更新",
  "wsl.onboarding.klautcodeReadyIn": "{{distro}}内のKlautcodeの準備ができました。",
  "wsl.onboarding.klautcodeReady": "Klautcodeの準備ができました。",
  "wsl.onboarding.installKlautcodeIn": "{{distro}}にKlautcodeをインストールしてください。",
  "wsl.onboarding.installKlautcode": "Klautcodeをインストール",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KlautcodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Klautcodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Klautcode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKlautcodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (klautcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KlautcodeはまだMCP認証をサポートしていません。',
  ...
  "session.title.regenerate": "タイトルを再生成",
  "session.title.regenerated": "タイトルを再生成しました",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKlautcodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Klautcodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKlautcodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Klautcodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Klautcodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Klautcode の起動時に自動でアップデートを確認します",
