export const dict = {
  ...
  "desktop.recovery.loadFailed": "Klautcode gagal dimuat",
  "desktop.recovery.terminated": "Jendela Klautcode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Klautcode tidak merespons",
  ...
  "desktop.wsl.error.installKlautcode": "Instalasi Klautcode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.klautcodeMissing": "klautcode belum terinstal di distro ini",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Klautcode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.klautcode.tagline": "Model andal yang dioptimalkan",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Klautcode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di klautcode.json",
  ...
  "dialog.server.description": "Ganti server Klautcode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingKlautcode": "Memeriksa Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Memeriksa Klautcode di {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Memperbarui Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Memperbarui Klautcode di {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Perbarui Klautcode di {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Perbarui Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode siap di {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode siap.",
  "wsl.onboarding.installKlautcodeIn": "Instal Klautcode di {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instal Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Klautcode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Klautcode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Klautcode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Klautcode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (klautcode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Klautcode belum mendukung autentikasi MCP.',
  ...
  "session.followupDock.delete": "Hapus",
  ...
  "session.title.regenerate": "Buat ulang judul",
  "session.title.regenerated": "Judul dibuat ulang",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Klautcode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Klautcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Klautcode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Klautcode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Klautcode diluncurkan",
