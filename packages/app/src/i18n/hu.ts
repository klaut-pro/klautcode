...
const desktop = [
  ...
  "Kilépés",
  "Az Klautcode betöltése sikertelen",
  "Az Klautcode ablaka váratlanul leállt",
  "Az Klautcode nem válaszol",
  ...
  "Az Klautcode telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az klautcode nincs telepítve ebben a disztribúcióban",
  "Az klautcode telepítve van, de nem futtatható",
  "Az Klautcode nincs telepítve ebben: {{distro}}",
  "Az Klautcode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "agent.mode.multitask": "többfeladatos",
  ...
  "dialog.provider.klautcode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.klautcode.tagline": "Megbízható optimalizált modellek",
  ...
  "dialog.model.unpaid.freeModels.title": "A Klautcode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Klautcode-ben.",
  ...
  "provider.connect.klautcodeZen.line1":
    "A Klautcode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Látogatás",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Klautcode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Klautcode-ben.",
  ...
  "dialog.plugins.empty": "Az klautcode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Klautcode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode ellenőrzése...",
  "wsl.onboarding.checkingKlautcodeIn": "Klautcode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingKlautcode": "Klautcode frissítése...",
  "wsl.onboarding.updatingKlautcodeIn": "Klautcode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateKlautcodeIn": "Frissítse a Klautcode-t a {{distro}}-ben.",
  "wsl.onboarding.updateKlautcode": "Frissítse a Klautcode-t",
  "wsl.onboarding.klautcodeReadyIn": "A Klautcode készen áll a {{distro}}-ben.",
  "wsl.onboarding.klautcodeReady": "A Klautcode készen áll.",
  "wsl.onboarding.installKlautcodeIn": "Telepítse a Klautcode-t a {{distro}}-be.",
  "wsl.onboarding.installKlautcode": "Telepítse a Klautcode-t",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "A Klautcode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Klautcode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Klautcode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Klautcode programot.",
  ...
  "help.tabs.introduction": "A Klautcode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Klautcode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Klautcode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (klautcode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Klautcode még nem támogatja a MCP hitelesítést.',
  ...
  "session.followupDock.delete": "Törlés",
  ...
  "session.title.regenerate": "Cím újragenerálása",
  "session.title.regenerated": "Cím újragenerálva",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "A Klautcode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Klautcode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Klautcode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Klautcode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Klautcode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Klautcode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Klautcode témáját.",
  ...
  "settings.updates.row.startup.description": "A Klautcode indításakor automatikusan ellenőrizze a frissítéseket",
