export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Klautcode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Klautcode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Klautcode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.klautcodeMissing": "اس ڈسٹرو وچ klautcode انسٹال نئیں اے",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.klautcodeNotInstalled": "{{distro}} وچ Klautcode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Klautcode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.klautcode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.klautcode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Klautcode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "ویکھو ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Klautcode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Klautcode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "klautcode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Klautcode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode چیک کر رئے آں...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}} چ Klautcode دی جانچ پڑتال...",
  "wsl.onboarding.updatingKlautcode": "Klautcode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}} وچ Klautcode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateKlautcodeIn": "{{distro}} وچ Klautcode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateKlautcode": "Klautcode اپ ڈیٹ کرو",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}} چ تیار اے۔",
  "wsl.onboarding.klautcodeReady": "Klautcode تیار اے۔",
  "wsl.onboarding.installKlautcodeIn": "{{distro}} وچ Klautcode انسٹال کرو۔",
  "wsl.onboarding.installKlautcode": "Klautcode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Klautcode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Klautcode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Klautcode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Klautcode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (klautcode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Klautcode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "session.followupDock.delete": "حذف کرو",
  ...
  "session.title.regenerate": "ٹائٹل دوبارہ بناؤ",
  "session.title.regenerated": "ٹائٹل دوبارہ بنا دتا گیا",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Klautcode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Klautcode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Klautcode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Klautcode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Klautcode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Klautcode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
