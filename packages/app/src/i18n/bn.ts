export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Klautcode ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Klautcode মেনু",
  ...
  "desktop.recovery.loadFailed": "Klautcode লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Klautcode উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Klautcode সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.klautcodeMissing": "এই ডিস্ট্রোতে klautcode ইনস্টল করা নেই",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "Klautcode আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "agent.mode.multitask": "মাল্টিটাস্ক",
  ...
  "dialog.provider.klautcode.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.klautcode.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি Klautcode দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Klautcode-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  "provider.connect.oauth.code.visit.prefix": "ভিজিট করুন",
  "provider.connect.oauth.code.visit.link": "এই লিঙ্ক",
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Klautcode-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Klautcode-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "klautcode.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Klautcode সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}} এ Klautcode চেক করা হচ্ছে...",
  "wsl.onboarding.updatingKlautcode": "আপডেট করা হচ্ছে Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}}-এ Klautcode আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateKlautcodeIn": "{{distro}}-এ Klautcode আপডেট করুন।",
  "wsl.onboarding.updateKlautcode": "Klautcode আপডেট করুন",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.klautcodeReady": "Klautcode প্রস্তুত।",
  "wsl.onboarding.installKlautcodeIn": "{{distro}}-এ Klautcode ইনস্টল করুন।",
  "wsl.onboarding.installKlautcode": "Klautcode ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Klautcode একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "Klautcode এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর Klautcode আবার খুলুন।",
  ...
  "help.tabs.introduction": "Klautcode ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Klautcode টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (klautcode.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, Klautcode এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "session.followupDock.delete": "মুছুন",
  ...
  "session.title.regenerate": "শিরোনাম পুনরায় তৈরি করুন",
  "session.title.regenerated": "শিরোনাম পুনরায় তৈরি করা হয়েছে",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "Klautcode ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Klautcode সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Klautcode-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Klautcode কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Klautcode সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Klautcode থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Klautcode চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
