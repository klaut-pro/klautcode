export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Klautcode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Klautcode",
  "desktop.recovery.terminated": "Klautcode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Klautcode neatbild",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.klautcodeMissing": "klautcode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "agent.mode.multitask": "vairākuzdevumu",
  ...
  "dialog.provider.klautcode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.klautcode.tagline": "Uzticami optimizēti modeļi",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Klautcode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti klautcode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Klautcode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingKlautcode": "Pārbaudu Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Pārbaudu Klautcode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Atjauninu Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Atjauninu Klautcode distribūcijā {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Atjauniniet Klautcode distribūcijā {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Atjauniniet Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode ir gatavs.",
  "wsl.onboarding.installKlautcodeIn": "Instalējiet Klautcode distribūcijā {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instalējiet Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Klautcode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Klautcode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Klautcode no jauna.",
  ...
  "help.tabs.introduction": "Klautcode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Klautcode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Klautcode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (klautcode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Klautcode vēl neatbalsta MCP autentifikāciju.',
  ...
  "session.followupDock.delete": "Dzēst",
  ...
  "session.title.regenerate": "Ģenerēt nosaukumu no jauna",
  "session.title.regenerated": "Nosaukums ģenerēts no jauna",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Klautcode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Klautcode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Klautcode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Klautcode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Klautcode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Klautcode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Klautcode",
