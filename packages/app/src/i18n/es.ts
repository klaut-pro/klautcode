export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Klautcode",
  ...
  "desktop.menu.ariaLabel": "Menú de Klautcode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Klautcode",
  "desktop.recovery.terminated": "La ventana de Klautcode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Klautcode no responde",
  ...
  "desktop.wsl.error.installKlautcode": "No se pudo instalar Klautcode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.klautcodeMissing": "klautcode no está instalado en esta distribución",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Klautcode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "agent.mode.multitask": "multitarea",
  ...
  "dialog.provider.klautcode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.klautcode.tagline": "Modelos optimizados y fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.klautcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Klautcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en klautcode.json",
  ...
  "mcp.auth.needsAuthentication": "El servidor MCP {{name}} requiere autenticación",
  ...
  "dialog.server.description": "Cambiar el servidor de Klautcode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingKlautcode": "Comprobando Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Comprobando Klautcode en {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Actualizando Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Actualizando Klautcode en {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Actualiza Klautcode en {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Actualizar Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode está listo en {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode está listo.",
  "wsl.onboarding.installKlautcodeIn": "Instala Klautcode en {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instalar Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Klautcode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Klautcode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Klautcode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Klautcode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (klautcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Klautcode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Klautcode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Klautcode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Klautcode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Klautcode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Klautcode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Klautcode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Klautcode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Klautcode.",
  "settings.updates.toast.missingArtifacts": "La última versión aún no tiene una actualización para esta plataforma.",
