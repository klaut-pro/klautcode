export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Klautcode",
  ...
  "desktop.recovery.loadFailed": "Klautcode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Klautcode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Klautcode ne reaguje",
  ...
  "desktop.wsl.error.installKlautcode": "Instalacija Klautcode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.klautcodeMissing": "klautcode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Klautcode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "agent.mode.multitask": "višezadaćni",
  ...
  "dialog.provider.klautcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.klautcode.tagline": "Pouzdani optimizovani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Klautcode-u.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Klautcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Klautcode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u klautcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se Klautcode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingKlautcode": "Provjera Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Provjera Klautcode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Ažuriranje Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Ažuriranje Klautcode u distribuciji {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Ažuriraj Klautcode u distribuciji {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Ažuriraj Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode je spreman.",
  "wsl.onboarding.installKlautcodeIn": "Instaliraj Klautcode u distribuciji {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instaliraj Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Klautcode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Klautcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Klautcode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (klautcode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Klautcode još ne podržava MCP autentifikaciju.',
  ...
  "session.title.regenerate": "Ponovo generiši naslov",
  "session.title.regenerated": "Naslov ponovo generisan",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Klautcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Klautcode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Klautcode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Klautcode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Klautcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Klautcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Klautcode-a.",
  "settings.updates.toast.missingArtifacts": "Najnovije izdanje još nema ažuriranje za ovu platformu.",
