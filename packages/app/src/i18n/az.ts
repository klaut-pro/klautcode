export const dict = {
  ...
  "desktop.recovery.loadFailed": "Klautcode yüklənə bilmədi",
  "desktop.recovery.terminated": "Klautcode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Klautcode cavab vermir",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.klautcodeMissing": "Bu distribütivdə klautcode quraşdırılmayıb",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Klautcode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.klautcode.tagline": "Etibarlı optimallaşdırılmış modellər",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Klautcode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Klautcode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Klautcode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər klautcode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Klautcode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode yoxlanılır...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}}-də Klautcode yoxlanılır...",
  "wsl.onboarding.updatingKlautcode": "Klautcode yenilənir...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}}-də Klautcode yenilənir...",
  "wsl.onboarding.updateKlautcodeIn": "{{distro}}-də Klautcode-u yeniləyin.",
  "wsl.onboarding.updateKlautcode": "Klautcode-u yeniləyin",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}}-də hazırdır.",
  "wsl.onboarding.klautcodeReady": "Klautcode hazırdır.",
  "wsl.onboarding.installKlautcodeIn": "Klautcode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installKlautcode": "Klautcode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Klautcode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Klautcode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Klautcode-u yenidən açın.",
  ...
  "help.tabs.introduction": "Klautcode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Klautcode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (klautcode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Klautcode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "session.title.regenerate": "Başlığı yenidən yarat",
  "session.title.regenerated": "Başlıq yenidən yaradıldı",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Klautcode serverini işlət.",
  ...
  "settings.general.row.language.description": "Klautcode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Klautcode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Klautcode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Klautcode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Klautcode açıldıqda avtomatik yeniləmələri yoxla",
