export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Klautcode कागजात",
  ...
  "desktop.menu.ariaLabel": "Klautcode मेनु",
  ...
  "desktop.recovery.loadFailed": "Klautcode लोड हुन सकेन",
  "desktop.recovery.terminated": "Klautcode विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "Klautcode ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.klautcodeMissing": "Klautcode यस distro मा स्थापित छैन",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "Klautcode अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.klautcode.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र Klautcode मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  "provider.connect.oauth.code.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.oauth.code.visit.link": "यो लिङ्क",
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र Klautcode मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू Klautcode मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.plugins.empty": "klautcode.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "dialog.server.description": "यो एप जडान भएको Klautcode सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode जाँच गर्दै...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}} मा Klautcode जाँच गर्दै...",
  "wsl.onboarding.updatingKlautcode": "अद्यावधिक गर्दै Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}} मा Klautcode अद्यावधिक गर्दै...",
  "wsl.onboarding.updateKlautcodeIn": "अपडेट गर्नुहोस् Klautcode {{distro}} मा।",
  "wsl.onboarding.updateKlautcode": "अपडेट गर्नुहोस् Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}} मा तयार छ।",
  "wsl.onboarding.klautcodeReady": "Klautcode तयार छ।",
  "wsl.onboarding.installKlautcodeIn": "{{distro}} मा Klautcode स्थापना गर्नुहोस्।",
  "wsl.onboarding.installKlautcode": "Klautcode स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) Klautcode ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि Klautcode पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "Klautcode डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि Klautcode टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (klautcode.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, Klautcode ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "session.followupDock.delete": "मेटाउनुहोस्",
  ...
  "session.title.regenerate": "शीर्षक पुन: उत्पन्न गर्नुहोस्",
  "session.title.regenerated": "शीर्षक पुन: उत्पन्न गरियो",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "app.name.desktop": "Klautcode डेस्कटप",
  ...
  "settings.desktop.wsl.description": "Klautcode सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "Klautcode को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा Klautcode कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "Klautcode ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी Klautcode विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "Klautcode सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं Klautcode को नवीनतम संस्करण चलाइरहनुभएको छ।",
  "settings.updates.toast.missingArtifacts": "पछिल्लो रिलीजमा यो प्लेटफर्मका लागि अहिलेसम्म कुनै अपडेट छैन।",
