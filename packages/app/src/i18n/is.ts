...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Klautcode",
  "Klautcode-glugganum var óvænt lokað",
  "Klautcode svarar ekki",
  ...
  "Uppsetning Klautcode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "klautcode er ekki uppsett í þessari dreifingu",
  "klautcode er uppsett en ekki var hægt að keyra það",
  "Klautcode er ekki uppsett í {{distro}}",
  "Uppfærslu Klautcode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "agent.mode.multitask": "fjölverkavinnsla",
  ...
  "dialog.provider.klautcode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.klautcode.tagline": "Áreiðanleg bjartsýni módel",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.klautcodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.klautcodeZen.visit.prefix": "Heimsókn",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Klautcode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í klautcode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Klautcode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingKlautcode": "Athugar Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Athugar Klautcode í {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Uppfærir Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Uppfærir Klautcode í {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Uppfærðu Klautcode í {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Uppfærðu Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode er tilbúið í {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode er tilbúinn.",
  "wsl.onboarding.installKlautcodeIn": "Settu upp Klautcode í {{distro}}.",
  "wsl.onboarding.installKlautcode": "Settu upp Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Klautcode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Klautcode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Klautcode aftur.",
  ...
  "help.tabs.introduction": "Klautcode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Klautcode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Klautcode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (klautcode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Klautcode styður ekki MCP auðkenningu ennþá.",
  ...
  "session.followupDock.delete": "Eyða",
  ...
  "session.title.regenerate": "Endurgera titil",
  "session.title.regenerated": "Titill endurgerður",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Klautcode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Klautcode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Klautcode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Klautcode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Klautcode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Klautcode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Klautcode ræsir",
