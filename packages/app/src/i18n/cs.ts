export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Klautcode",
  ...
  "desktop.recovery.loadFailed": "Klautcode se nepodařilo načíst",
  "desktop.recovery.terminated": "Klautcode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Klautcode nereaguje",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.klautcodeMissing": "klautcode není v této distribuci nainstalováno",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.klautcode.tagline": "Spolehlivé optimalizované modely",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Návštěva ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Klautcode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v klautcode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Klautcode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingKlautcode": "Kontrola Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Kontrola Klautcode v {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Aktualizace Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Aktualizace Klautcode v {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Aktualizace Klautcode v {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Aktualizovat Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode je připraveno v {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode je připraven.",
  "wsl.onboarding.installKlautcodeIn": "Nainstalujte Klautcode do {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instalovat Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Klautcode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Klautcode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Klautcode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (klautcode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Klautcode zatím nepodporuje ověřování MCP.',
  ...
  "session.followupDock.delete": "Odstranit",
  ...
  "session.title.regenerate": "Znovu vygenerovat název",
  "session.title.regenerated": "Název znovu vygenerován",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Klautcode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Klautcode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Klautcode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Klautcode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Klautcode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Klautcode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Klautcode.",
  "settings.updates.toast.missingArtifacts": "Nejnovější vydání zatím nemá aktualizaci pro tuto platformu.",
