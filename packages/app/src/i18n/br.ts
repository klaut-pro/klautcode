export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Klautcode",
  ...
  "desktop.menu.ariaLabel": "Menu do Klautcode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Klautcode",
  "desktop.recovery.terminated": "A janela do Klautcode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Klautcode não está respondendo",
  ...
  "desktop.wsl.error.installKlautcode": "Falha na instalação do Klautcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.klautcodeMissing": "O klautcode não está instalado nesta distribuição",
  "desktop.wsl.error.klautcodeCannotRun": "O klautcode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.klautcodeNotInstalled": "O Klautcode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Klautcode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "agent.mode.multitask": "multitarefa",
  ...
  "dialog.provider.klautcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.klautcode.tagline": "Modelos otimizados e confiáveis",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Visite ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Klautcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em klautcode.json",
  ...
  "mcp.auth.needsAuthentication": "O servidor MCP {{name}} precisa de autenticação",
  ...
  "dialog.server.description": "Trocar para qual servidor Klautcode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingKlautcode": "Verificando o Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Verificando o Klautcode em {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Atualizando o Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Atualizando o Klautcode em {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Atualize o Klautcode em {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Atualizar o Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "O Klautcode está pronto em {{distro}}.",
  "wsl.onboarding.klautcodeReady": "O Klautcode está pronto.",
  "wsl.onboarding.installKlautcodeIn": "Instale o Klautcode em {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instalar o Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Klautcode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Klautcode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Klautcode novamente.",
  ...
  "help.tabs.introduction": "Agora, o Klautcode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Klautcode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Klautcode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (klautcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Klautcode ainda não suporta autenticação MCP.',
  ...
  "session.title.regenerate": "Regenerar título",
  "session.title.regenerated": "Título regenerado",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Klautcode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Klautcode",
  ...
  "settings.general.row.appearance.description": "Personalize como o Klautcode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Klautcode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Klautcode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Klautcode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Klautcode.",
  "settings.updates.toast.missingArtifacts": "A versão mais recente ainda não tem atualização para esta plataforma.",
