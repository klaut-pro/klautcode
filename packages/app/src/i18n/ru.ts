export const dict = {
  ...
  "desktop.menu.documentation": "Документация Klautcode",
  ...
  "desktop.menu.ariaLabel": "Меню Klautcode",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Klautcode",
  "desktop.recovery.terminated": "Окно Klautcode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Klautcode не отвечает",
  ...
  "desktop.wsl.error.installKlautcode": "Не удалось установить Klautcode",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.klautcodeMissing": "klautcode не установлен в этом дистрибутиве",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode установлен, но его не удалось запустить",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Klautcode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "agent.mode.multitask": "многозадачный",
  ...
  "dialog.provider.klautcode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.klautcode.tagline": "Надёжные оптимизированные модели",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  "provider.connect.klautcodeZen.line2":
    "С одним ключом API вы получите доступ к таким моделям, как Claude, GPT, Gemini, GLM и другие.",
  "provider.connect.klautcodeZen.visit.prefix": "Посетите ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Klautcode.",
  ...
  "model.tooltip.cost.input": "Input",
  "model.tooltip.cost.output": "Output",
  "model.tooltip.cost.perMillionTokens": "/1M tokens",
  "model.tooltip.cost.line": "Input {{input}} · Output {{output}}",
  ...
  "dialog.plugins.empty": "Плагины настроены в klautcode.json",
  ...
  "mcp.auth.needsAuthentication": "Серверу MCP {{name}} требуется авторизация",
  "mcp.auth.authenticate": "Авторизоваться",
  ...
  "dialog.server.description": "Выберите сервер Klautcode, к которому подключается приложение.",
  ...
  "wsl.onboarding.step.klautcode": "Klautcode",
  ...
  "wsl.onboarding.checkingKlautcode": "Проверка Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Проверка Klautcode в {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Обновление Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Обновление Klautcode в {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Обновите Klautcode в {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Обновить Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode в {{distro}} готов к работе.",
  "wsl.onboarding.klautcodeReady": "Klautcode готов к работе.",
  "wsl.onboarding.installKlautcodeIn": "Установите Klautcode в {{distro}}.",
  "wsl.onboarding.installKlautcode": "Установить Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Klautcode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Klautcode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Klautcode.",
  ...
  "help.tabs.introduction": "Теперь работа в Klautcode Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Klautcode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Klautcode",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (klautcode.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Klautcode пока не поддерживает MCP-авторизацию.',
  ...
  "session.followupDock.delegateAll": "Delegate all",
  "session.followupDock.delegate": "Delegate",
  "session.followupDock.delegated.one": "Delegated {{count}} message to the coordinator",
  "session.followupDock.delegated.other": "Delegated {{count}} messages to the coordinator",
  "session.followupDock.delegated.few": "Delegated {{count}} messages to the coordinator",
  "session.followupDock.delegated.many": "Delegated {{count}} messages to the coordinator",
  "session.followupDock.delegateLaunched.one": "Coordinator launched {{count}} subagent",
  "session.followupDock.delegateLaunched.other": "Coordinator launched {{count}} subagents",
  "session.followupDock.delegateLaunched.few": "Coordinator launched {{count}} subagents",
  "session.followupDock.delegateLaunched.many": "Coordinator launched {{count}} subagents",
  "session.followupDock.changeModel": "Change model",
  ...
  "browser.history.empty": "No visited pages",
  ...
  "browser.markdownTab": "New markdown tab",
  "browser.openActiveAsMarkdown": "Open active file as markdown",
  "browser.plan.title": "Plan",
  "browser.plan.implement": "Implement",
  "browser.plan.more": "More plan actions",
  "browser.plan.parallel": "Parallel implementation",
  ...
  "session.title.regenerate": "Сгенерировать заголовок заново",
  "session.title.regenerated": "Заголовок сгенерирован заново",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "app.name.desktop": "Klautcode Desktop",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Klautcode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Klautcode",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Klautcode на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Klautcode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Klautcode.",
  ...
  "settings.general.row.font.option.systemMono": "System Mono",
  "settings.general.row.font.option.jetbrains": "JetBrainsMono Nerd Font Mono",
  ...
  "settings.general.row.terminalFont.option.systemMono": "System Mono",
  "settings.general.row.terminalFont.option.jetbrains": "JetBrainsMono Nerd Font Mono",
  ...
  "settings.general.row.uiFont.option.systemSans": "System Sans",
  "settings.general.row.uiFont.option.inter": "Inter",
  "settings.general.row.fontSize.title": "UI Font Size",
  "settings.general.row.fontSize.description": "Adjust the size of all text in the interface",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Klautcode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Klautcode.",
  "settings.updates.toast.missingArtifacts": "В последнем выпуске пока нет обновления для этой платформы.",
  ...
  "command.projectSidebar.toggle": "Toggle project sidebar",
  ...
  "dialog.importOpencode.title": "Import from opencode",
  "dialog.importOpencode.description": "We found {{count}} projects from an existing opencode installation. Import them to keep your chats.",
  "dialog.importOpencode.skip": "Not now",
  ...
  "projectSidebar.collapse": "Collapse project sidebar",
  "projectSidebar.showMore": "Show {{count}} more",
  "projectSidebar.showLess": "Show less",
  "settings.tab.permissions": "Permissions",
  "settings.tab.mcp": "MCP",
  "mcp.status.disconnected": "disconnected",
  "settings.tab.import": "Import",
  "settings.import.opencode.title": "Import from opencode",
  "settings.import.opencode.description": "Import projects and chats from an existing opencode instance stored in an opencode.db database.",
  "settings.import.opencode.chooseFolder": "Choose folder",
  "settings.import.opencode.chooseFolderLabel": "Choose an opencode data folder",
  "settings.import.opencode.scanning": "Scanning for opencode projects…",
  "settings.import.opencode.empty": "No opencode data found in {{directory}}. Choose the folder that contains the opencode.db file of your opencode instance.",
  "settings.import.opencode.projects": "Projects",
  "settings.import.opencode.sessions.one": "{{count}} chat",
  "settings.import.opencode.sessions.other": "{{count}} chats",
  "settings.import.opencode.importSelected": "Import selected",
  "settings.import.opencode.importing": "Importing…",
  "settings.import.opencode.done": "Import complete",
  "settings.import.opencode.done.summary": "Imported {{projects}} projects and {{sessions}} chats.",
  "settings.import.opencode.close": "Close",
  "settings.import.opencode.error": "Import failed",
  "settings.import.opencode.error.detail": "{{error}}",
  "settings.general.row.multitask.title": "Multitask mode",
  "settings.general.row.multitask.description": "Run subagents in parallel. Klautcode automatically determines the number of workers from your CPU.",
  "settings.import.opencode.sessions.few": "{{count}} chats",
  "settings.import.opencode.sessions.many": "{{count}} chats",
  "dialog.provider.hetzner.note": "Fast, open models hosted on Hetzner infrastructure",
  "session.subagents.stop": "Stop subagent",
  "projectSidebar.chats": "Chats",
  "settings.general.row.freeModels.title": "Free models",
  "settings.general.row.freeModels.description": "Use free models first before paid APIs",
  "settings.general.row.autoFreeMode.title": "Auto free mode",
  "settings.general.row.autoFreeMode.description": "Automatically use free models until quota is empty",
  "settings.general.row.reloadChats.title": "Reload chats",
  "settings.general.row.reloadChats.description": "Refresh the recent sessions list manually",
  "settings.general.row.reloadChats.action": "Reload",
  "settings.general.row.reloadChats.reloading": "Reloading\u2026",

  "command.designMode.toggle": "Toggle design mode",
  "designMode.title": "Design mode",
  "designMode.tool.select": "Select",
  "designMode.tool.marker": "Marker",
  "designMode.tool.circle": "Circle",
  "designMode.tool.rect": "Rectangle",
  "designMode.tool.arrow": "Arrow",
  "designMode.tool.freehand": "Freehand",
  "designMode.tool.text": "Text",
  "designMode.width": "Stroke width",
  "designMode.dim": "Dim previous annotations",
  "designMode.textPlaceholder": "Annotation text",
  "designMode.notePlaceholder": "Annotation text",
  "designMode.actions.undo": "Undo",
  "designMode.actions.clear": "Clear annotations",
  "designMode.actions.remove": "Remove annotation",
  "designMode.actions.cancel": "Cancel",
  "designMode.actions.addToChat": "Add to chat",
  "designMode.actions.busy": "Adding…",
  "designMode.hint.main": "Click elements to add numbered markers, drag to draw",
  "designMode.hint.ancestor": "Alt-click to select a parent element",
  "designMode.count.element": "element",
  "designMode.count.elements": "elements",
