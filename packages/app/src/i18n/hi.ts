export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Klautcode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Klautcode लोड नहीं हो सका",
  "desktop.recovery.terminated": "Klautcode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Klautcode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.klautcodeMissing": "इस डिस्ट्रो में klautcode इंस्टॉल नहीं है",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.klautcodeNotInstalled": "{{distro}} में Klautcode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Klautcode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "agent.mode.multitask": "मल्टीटास्क",
  ...
  "dialog.provider.klautcode.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.klautcode.tagline": "विश्वसनीय अनुकूलित मॉडल",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Klautcode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  "provider.connect.klautcodeZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.klautcodeZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  "provider.connect.oauth.code.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.oauth.code.visit.link": "इस लिंक",
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Klautcode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Klautcode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन klautcode.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Klautcode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode की जाँच हो रही है...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}} में Klautcode की जाँच हो रही है...",
  "wsl.onboarding.updatingKlautcode": "Klautcode अपडेट हो रहा है...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}} में Klautcode अपडेट हो रहा है...",
  "wsl.onboarding.updateKlautcodeIn": "{{distro}} में Klautcode को अपडेट करें।",
  "wsl.onboarding.updateKlautcode": "Klautcode को अपडेट करें",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}} में तैयार है।",
  "wsl.onboarding.klautcodeReady": "Klautcode तैयार है।",
  "wsl.onboarding.installKlautcodeIn": "{{distro}} में Klautcode स्थापित करें।",
  "wsl.onboarding.installKlautcode": "Klautcode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Klautcode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Klautcode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Klautcode को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Klautcode Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Klautcode टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (klautcode.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Klautcode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "session.followupDock.delete": "हटाएँ",
  ...
  "session.title.regenerate": "शीर्षक फिर से बनाएँ",
  "session.title.regenerated": "शीर्षक फिर से बनाया गया",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Klautcode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Klautcode के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Klautcode आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Klautcode सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Klautcode की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Klautcode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Klautcode का नवीनतम संस्करण चला रहे हैं।",
  "settings.updates.toast.missingArtifacts": "नवीनतम रिलीज़ में अभी तक इस प्लेटफ़ॉर्म के लिए कोई अपडेट नहीं है।",
