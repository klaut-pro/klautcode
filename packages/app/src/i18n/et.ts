export const dict = {
  ...
  "desktop.recovery.loadFailed": "Klautcode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Klautcode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Klautcode ei vasta",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.klautcodeMissing": "klautcode pole sellesse distrosse installitud",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "agent.mode.multitask": "multitegumtöö",
  ...
  "dialog.provider.klautcode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.klautcode.tagline": "Usaldusväärsed optimeeritud mudelid",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Klautcode'is.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Külastage ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Klautcode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis klautcode.json",
  ...
  "dialog.server.description": "Lülitage, millise Klautcode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode kontrollimine...",
  "wsl.onboarding.checkingKlautcodeIn": "Klautcode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Klautcode värskendamine...",
  "wsl.onboarding.updatingKlautcodeIn": "Klautcode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Värskenda Klautcode jaotises {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Värskenda Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode on valmis {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode on valmis.",
  "wsl.onboarding.installKlautcodeIn": "Installige Klautcode asukohta {{distro}}.",
  "wsl.onboarding.installKlautcode": "Installige Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Klautcode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Klautcode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Klautcode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (klautcode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Klautcode ei toeta veel MCP autentimist.',
  ...
  "session.followupDock.delete": "Kustuta",
  ...
  "session.title.regenerate": "Genereeri pealkiri uuesti",
  "session.title.regenerated": "Pealkiri genereeriti uuesti",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Klautcode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Klautcode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Klautcode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Klautcode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Klautcode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Klautcode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Klautcode käivitub",
