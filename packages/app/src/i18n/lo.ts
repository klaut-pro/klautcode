export const dict = {
  ...
  "desktop.menu.documentation": "ເອກະສານ Klautcode",
  ...
  "desktop.menu.ariaLabel": "ເມນູ Klautcode",
  ...
  "desktop.recovery.loadFailed": "Klautcode ລົ້ມເຫລວໃນການໂຫລດ",
  "desktop.recovery.terminated": "ປ່ອງຢ້ຽມ Klautcode ຖືກປິດໂດຍບໍ່ຄາດຄິດ",
  "desktop.recovery.unresponsive": "Klautcode ບໍ່ຕອບສະໜອງ",
  ...
  "desktop.wsl.error.installKlautcode": "ການຕິດຕັ້ງ Klautcode ລົ້ມເຫລວ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ຖືກເພີ່ມແລ້ວ",
  "desktop.wsl.error.klautcodeMissing": "klautcode ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ distro ນີ້",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode ຖືກຕິດຕັ້ງແຕ່ບໍ່ສາມາດດໍາເນີນການໄດ້",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ການປັບປຸງ Klautcode ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "agent.mode.multitask": "ຫຼາຍວຽກງານ",
  ...
  "dialog.provider.klautcode.note": "ແບບທີ່ຄັດສັນມາລວມທັງ Claude, GPT, Gemini ແລະອື່ນໆ",
  "dialog.provider.klautcode.tagline": "ຮູບແບບການເພີ່ມປະສິດທິພາບທີ່ເຊື່ອຖືໄດ້",
  ...
  "dialog.model.unpaid.freeModels.title": "ແບບຟຣີສະໜອງໃຫ້ໂດຍ Klautcode",
  ...
  "provider.connect.apiKey.description":
    "ໃສ່ລະຫັດ API {{provider}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen ໃຫ້ທ່ານເຂົ້າເຖິງຊຸດຮູບແບບການປັບແຕ່ງທີ່ໜ້າເຊື່ອຖືໄດ້ສຳລັບຕົວແທນການເຂົ້າລະຫັດ.",
  "provider.connect.klautcodeZen.line2":
    "ດ້ວຍລະຫັດ API ດຽວເຈົ້າຈະໄດ້ຮັບການເຂົ້າເຖິງຕົວແບບເຊັ່ນ: Claude, GPT, Gemini, GLM ແລະອື່ນໆ.",
  "provider.connect.klautcodeZen.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "ເພື່ອເກັບກຳລະຫັດ API ຂອງທ່ານ.",
  "provider.connect.oauth.code.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.oauth.code.visit.link": "ລິ້ງນີ້",
  "provider.connect.oauth.code.visit.suffix":
    "ເພື່ອເກັບກຳລະຫັດການອະນຸຍາດຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ແລະໃສ່ລະຫັດຂ້າງລຸ່ມນີ້ເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Klautcode.",
  ...
  "dialog.plugins.empty": "ປລັກອິນຖືກຕັ້ງຄ່າໃນ klautcode.json",
  ...
  "dialog.server.description": "ສະຫຼັບເຊີບເວີ Klautcode ທີ່ແອັບຯນີ້ເຊື່ອມຕໍ່ກັບ.",
  ...
  "wsl.onboarding.checkingKlautcode": "ກຳລັງກວດສອບ Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "ກຳລັງກວດສອບ Klautcode ໃນ {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "ກຳລັງອັບເດດ Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "ກຳລັງອັບເດດ Klautcode ໃນ {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "ອັບເດດ Klautcode ໃນ {{distro}}.",
  "wsl.onboarding.updateKlautcode": "ອັບເດດ Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode ພ້ອມແລ້ວ.",
  "wsl.onboarding.installKlautcodeIn": "ຕິດຕັ້ງ Klautcode ໃນ {{distro}}.",
  "wsl.onboarding.installKlautcode": "ຕິດຕັ້ງ Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ Klautcode ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ Klautcode ຄືນໃໝ່.",
  ...
  "help.tabs.introduction": "Klautcode Desktop ຕອນນີ້ຖືກສ້າງຂຶ້ນໃນແຖບຕ່າງໆ.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "ເວີຊັນໃໝ່ຂອງ Klautcode ({{version}}) ມີໃຫ້ຕິດຕັ້ງແລ້ວ.",
  ...
  "error.page.report.prefix": "ກະລຸນາລາຍງານຄວາມຜິດພາດນີ້ໃຫ້ທີມງານ Klautcode",
  ...
  "error.chain.checkConfig": "ກວດເບິ່ງການຕັ້ງຄ່າ (klautcode.json) ຜູ້ໃຫ້ບໍລິການ/ຊື່ແບບຈໍາລອງຂອງທ່ານ",
  "error.chain.mcpFailed": 'ເຊີບເວີ MCP "{{name}}" ລົ້ມເຫລວ. ໝາຍເຫດ, Klautcode ບໍ່ຮອງຮັບການພິສູດຢືນຢັນ MCP ເທື່ອ.',
  ...
  "session.followupDock.delete": "ລຶບ",
  ...
  "session.title.regenerate": "ສ້າງຫົວຂໍ້ຄືນໃໝ່",
  "session.title.regenerated": "ສ້າງຫົວຂໍ້ຄືນໃໝ່ແລ້ວ",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode ປະກອບມີຮູບແບບຟຣີເພື່ອໃຫ້ທ່ານສາມາດເລີ່ມຕົ້ນໄດ້ທັນທີ.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ Klautcode ພາຍໃນ WSL ໃນ Windows.",
  ...
  "settings.general.row.language.description": "ປ່ຽນພາສາສະແດງສໍາລັບ Klautcode",
  ...
  "settings.general.row.appearance.description": "ປັບແຕ່ງວິທີ Klautcode ເບິ່ງຢູ່ໃນອຸປະກອນຂອງທ່ານ",
  "settings.general.row.colorScheme.title": "ຮູບແບບສີ",
  "settings.general.row.colorScheme.description": "ເລືອກວ່າ Klautcode ປະຕິບັດຕາມລະບົບ, ແສງສະຫວ່າງ, ຫຼືຮູບແບບຊ້ໍາ",
  "settings.general.row.theme.title": "ຫົວຂໍ້",
  "settings.general.row.theme.description": "ປັບແຕ່ງວິທີ Klautcode ເປັນຫົວຂໍ້.",
  ...
  "settings.updates.row.startup.description": "ກວດສອບການອັບເດດໂດຍອັດຕະໂນມັດເມື່ອ Klautcode ເປີດ",
