export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Klautcode.",
  ...
  "desktop.recovery.loadFailed": "Klautcode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Klautcode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Klautcode no respon",
  ...
  "desktop.wsl.error.installKlautcode": "La instal·lació de Klautcode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.klautcodeMissing": "klautcode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "agent.mode.multitask": "multitasca",
  ...
  "dialog.provider.klautcode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.klautcode.tagline": "Models optimitzats fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.klautcodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Klautcode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a klautcode.json",
  ...
  "dialog.server.description": "Canvia a quin Klautcode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingKlautcode": "S'està comprovant Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "S'està registrant Klautcode a {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "S'està actualitzant Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "S'està actualitzant Klautcode a {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Actualitza Klautcode a {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Actualització Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode està llest a {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode està llest.",
  "wsl.onboarding.installKlautcodeIn": "Instal·leu Klautcode a {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instal·la Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Klautcode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Klautcode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Klautcode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Klautcode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (klautcode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Klautcode encara no admet l\'autenticació MCP.',
  ...
  "session.title.regenerate": "Torna a generar el títol",
  "session.title.regenerated": "Títol generat de nou",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Klautcode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Klautcode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Klautcode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Klautcode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Klautcode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Klautcode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Klautcode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Klautcode.",
  "settings.updates.toast.missingArtifacts": "L'última versió encara no té una actualització per a aquesta plataforma.",
