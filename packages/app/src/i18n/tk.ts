export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Klautcode menýusy",
  ...
  "desktop.recovery.loadFailed": "Klautcode ýükläp bilmedi",
  "desktop.recovery.terminated": "Klautcode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Klautcode jogap berenok",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.klautcodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Klautcode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "agent.mode.multitask": "köp wezipeli",
  ...
  "dialog.provider.klautcode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.klautcode.tagline": "Ygtybarly optimal modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Klautcode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Sapar ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Klautcode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Klautcode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "klautcode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Klautcode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode barlamak ...",
  "wsl.onboarding.checkingKlautcodeIn": "{{distro}} içinde Klautcode barlanýar...",
  "wsl.onboarding.updatingKlautcode": "Klautcode täzelenmek ...",
  "wsl.onboarding.updatingKlautcodeIn": "{{distro}}-de Klautcode täzelenmek ...",
  "wsl.onboarding.updateKlautcodeIn": "Klautcode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateKlautcode": "Klautcode täzeläň",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}}-de taýýar.",
  "wsl.onboarding.klautcodeReady": "Klautcode taýýar.",
  "wsl.onboarding.installKlautcodeIn": "{{distro}}-de Klautcode guruň.",
  "wsl.onboarding.installKlautcode": "Klautcode guruň",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Klautcode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Klautcode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Klautcode açyň.",
  ...
  "help.tabs.introduction": "Klautcode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Klautcode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Klautcode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (klautcode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Klautcode entek MCP tassyklamasyny goldamaýar.',
  ...
  "session.followupDock.delete": "Pozmak",
  ...
  "session.title.regenerate": "Ady täzeden dörediň",
  "session.title.regenerated": "Ady täzeden döredildi",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Klautcode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Klautcode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Klautcode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Klautcode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Klautcode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Klautcode işe başlanda täzelenmeleri awtomatiki barlaň",
