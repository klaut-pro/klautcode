...
export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "Klautcode kunne ikke lastes inn",
  "desktop.recovery.terminated": "Klautcode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Klautcode svarer ikke",
  ...
  "desktop.wsl.error.installKlautcode": "Installasjonen av Klautcode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.klautcodeMissing": "klautcode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Klautcode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.klautcode.tagline": "Pålitelige, optimaliserte modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Besøk ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Klautcode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i klautcode.json",
  ...
  "dialog.server.description": "Bytt hvilken Klautcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Klautcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Klautcode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (klautcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Klautcode ikke støtter MCP-autentisering ennå.',
  ...
  "session.title.regenerate": "Generer tittel på nytt",
  "session.title.regenerated": "Tittel generert på nytt",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Klautcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Klautcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Klautcode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Klautcode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Klautcode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Klautcode starter",
  ...
  "wsl.onboarding.checkingKlautcode": "Sjekker Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Sjekker Klautcode i {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Oppdaterer Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Oppdaterer Klautcode i {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Oppdater Klautcode i {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Oppdater Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode er klar i {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode er klar.",
  "wsl.onboarding.installKlautcodeIn": "Installer Klautcode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Klautcode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Klautcode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Klautcode på nytt.",
  ...
  "help.tabs.introduction": "Klautcode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
