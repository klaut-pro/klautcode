export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Klautcode menyusi",
  ...
  "desktop.recovery.loadFailed": "Klautcode yuklanmadi",
  "desktop.recovery.terminated": "Klautcode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Klautcode javob bermayapti",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.klautcodeMissing": "Klautcode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Klautcode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "agent.mode.multitask": "koʻp vazifali",
  ...
  "dialog.provider.klautcode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.klautcode.tagline": "Ishonchli optimallashtirilgan modellar",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Klautcode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Klautcode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Klautcode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "klautcode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Klautcode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingKlautcode": "Klautcode tekshirilmoqda...",
  "wsl.onboarding.checkingKlautcodeIn": "Klautcode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingKlautcode": "Klautcode yangilanmoqda...",
  "wsl.onboarding.updatingKlautcodeIn": "Klautcode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateKlautcodeIn": "Klautcode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateKlautcode": "Klautcode-ni yangilang",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode {{distro}} da tayyor.",
  "wsl.onboarding.klautcodeReady": "Klautcode tayyor.",
  "wsl.onboarding.installKlautcodeIn": "Klautcode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installKlautcode": "Klautcode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Klautcode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Klautcode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Klautcode-ni qayta oching.",
  ...
  "help.tabs.introduction": "Klautcode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Klautcode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (klautcode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Klautcode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "session.followupDock.delete": "O'chirish",
  ...
  "session.title.regenerate": "Sarlavhani qayta yaratish",
  "session.title.regenerated": "Sarlavha qayta yaratildi",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1":
    "Klautcode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Klautcode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Klautcode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Klautcode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Klautcode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Klautcode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Klautcode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
