...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Klautcode įkelti nepavyko",
  "Klautcode langas netikėtai užsidarė",
  "Klautcode neatsako",
  ...
  "Klautcode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "klautcode šiame distributyve neįdiegtas",
  "klautcode įdiegtas, bet jo paleisti nepavyko",
  "Klautcode neįdiegtas distributyve {{distro}}",
  "Klautcode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "agent.mode.multitask": "daugiaveika",
  ...
  "dialog.provider.klautcode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.klautcode.tagline": "Patikimi optimizuoti modeliai",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Klautcode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.klautcodeZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.klautcodeZen.visit.prefix": "Aplankykite",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Klautcode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti klautcode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Klautcode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingKlautcode": "Tikrinama Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Tikrinama Klautcode {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Atnaujinamas Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Atnaujinamas Klautcode {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Atnaujinkite Klautcode {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Atnaujinkite Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode yra paruoštas {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode yra paruoštas.",
  "wsl.onboarding.installKlautcodeIn": "Įdiekite Klautcode į {{distro}}.",
  "wsl.onboarding.installKlautcode": "Įdiekite Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Klautcode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Klautcode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Klautcode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (klautcode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Klautcode dar nepalaiko MCP autentifikavimo.",
  ...
  "session.followupDock.delete": "Ištrinti",
  ...
  "session.title.regenerate": "Iš naujo sugeneruoti pavadinimą",
  "session.title.regenerated": "Pavadinimas sugeneruotas iš naujo",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Klautcode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Klautcode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Klautcode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Klautcode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Klautcode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Klautcode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Klautcode",
