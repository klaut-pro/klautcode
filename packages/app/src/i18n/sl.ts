export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "Klautcode meni",
  ...
  "desktop.recovery.loadFailed": "Klautcode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Klautcode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Klautcode se ne odziva",
  ...
  "desktop.wsl.error.installKlautcode": "Namestitev Klautcode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.klautcodeMissing": "klautcode ni nameščen v tej distribuciji",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Klautcode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "agent.mode.multitask": "večopravilnost",
  ...
  "dialog.provider.klautcode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.klautcode.tagline": "Zanesljivi optimizirani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Obisk ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Klautcode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v klautcode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Klautcode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingKlautcode": "Preverjanje Klautcode ...",
  "wsl.onboarding.checkingKlautcodeIn": "Preverjanje Klautcode v {{distro}} ...",
  "wsl.onboarding.updatingKlautcode": "Posodabljanje Klautcode ...",
  "wsl.onboarding.updatingKlautcodeIn": "Posodabljanje Klautcode v {{distro}} ...",
  "wsl.onboarding.updateKlautcodeIn": "Posodobite Klautcode v {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Posodobite Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode je pripravljen v {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode je pripravljen.",
  "wsl.onboarding.installKlautcodeIn": "Namestite Klautcode v {{distro}}.",
  "wsl.onboarding.installKlautcode": "Namestite Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Klautcode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Klautcode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Klautcode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Klautcode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (klautcode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Klautcode še ne podpira avtentikacije MCP.',
  ...
  "session.followupDock.delete": "Izbriši",
  ...
  "session.title.regenerate": "Znova ustvari naslov",
  "session.title.regenerated": "Naslov je bil znova ustvarjen",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Klautcode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Klautcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Klautcode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Klautcode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Klautcode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Klautcode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Klautcode.",
  "settings.updates.toast.missingArtifacts": "Najnovejša izdaja še nima posodobitve za to platformo.",
