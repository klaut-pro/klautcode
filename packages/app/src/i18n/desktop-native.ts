...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Klautcode failed to load",
  "desktop.recovery.terminated": "Klautcode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Klautcode is not responding",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.klautcodeMissing": "klautcode is not installed in this distro",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode is installed but could not run",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
