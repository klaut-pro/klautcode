export const dict = {
  ...
  "desktop.recovery.loadFailed": "Klautcode መጫን አልቻለም",
  "desktop.recovery.terminated": "Klautcode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Klautcode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcodeመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.klautcodeMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.klautcodeCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Klautcode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.klautcode.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በKlautcode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በKlautcode ይጠቀሙ።",
  ...
  "provider.connect.klautcodeZen.line1": "Klautcode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.klautcodeZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.klautcodeZen.visit.prefix": "ጎብኝ ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በKlautcode ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በKlautcode ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ klautcode.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Klautcode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingKlautcode": "መፈተሽ Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Klautcodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingKlautcode": "በማዘመን ላይ Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "በማዘመን ላይ Klautcode በ{{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "አዘምን Klautcode በ{{distro}}።",
  "wsl.onboarding.updateKlautcode": "አዘምን Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.klautcodeReady": "Klautcode ዝግጁ ነው።",
  "wsl.onboarding.installKlautcodeIn": "መጫን Klautcode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installKlautcode": "ጫን Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Klautcode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Klautcode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Klautcode።",
  ...
  "help.tabs.introduction": "Klautcode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የKlautcode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለKlautcode ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (klautcode.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Klautcode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "session.followupDock.delete": "አጥፋ",
  ...
  "session.title.regenerate": "ርዕስን እንደገና ፍጠር",
  "session.title.regenerated": "ርዕስ እንደገና ተፈጥሯል",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Klautcode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የKlautcode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለKlautcode",
  ...
  "settings.general.row.appearance.description": "Klautcodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Klautcode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Klautcode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Klautcode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
