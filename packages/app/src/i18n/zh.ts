...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Klautcode 加载失败",
  "desktop.recovery.terminated": "Klautcode 窗口意外终止",
  "desktop.recovery.unresponsive": "Klautcode 未响应",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.klautcodeMissing": "此发行版中未安装 klautcode",
  "desktop.wsl.error.klautcodeCannotRun": "已安装 klautcode，但无法运行",
  "desktop.wsl.error.klautcodeNotInstalled": "{{distro}} 中未安装 Klautcode",
  "desktop.wsl.error.updateVersion":
    "Klautcode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.klautcode.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.klautcode.tagline": "可靠的优化模型",
  ...
  "dialog.model.unpaid.freeModels.title": "Klautcode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Klautcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.klautcodeZen.line1": "Klautcode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.klautcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.klautcodeZen.visit.prefix": "访问 ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Klautcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Klautcode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 klautcode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Klautcode 服务器。",
  ...
  "wsl.onboarding.checkingKlautcode": "正在检查 Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "正在检查 {{distro}} 中的 Klautcode...",
  "wsl.onboarding.updatingKlautcode": "正在更新 Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "正在更新 {{distro}} 中的 Klautcode...",
  "wsl.onboarding.updateKlautcodeIn": "更新 {{distro}} 中的 Klautcode。",
  "wsl.onboarding.updateKlautcode": "更新 Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "{{distro}} 中的 Klautcode 已就绪。",
  "wsl.onboarding.klautcodeReady": "Klautcode 已就绪。",
  "wsl.onboarding.installKlautcodeIn": "在 {{distro}} 中安装 Klautcode。",
  "wsl.onboarding.installKlautcode": "安装 Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "未安装 Klautcode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Klautcode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Klautcode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Klautcode。",
  ...
  "help.tabs.introduction": "Klautcode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Klautcode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (klautcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Klautcode 暂不支持 MCP 认证。',
  ...
  "session.title.regenerate": "重新生成标题",
  "session.title.regenerated": "标题已重新生成",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Klautcode 服务器。",
  ...
  "settings.general.row.language.description": "更改 Klautcode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Klautcode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Klautcode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Klautcode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Klautcode 启动时自动检查更新",
