export const dict = {
  ...
  "desktop.menu.ariaLabel": "Klautcode-meny",
  ...
  "desktop.recovery.loadFailed": "Klautcode kunde inte läsas in",
  "desktop.recovery.terminated": "Klautcode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Klautcode svarar inte",
  ...
  "desktop.wsl.error.installKlautcode": "Installationen av Klautcode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.klautcodeMissing": "klautcode är inte installerat i den här distributionen",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode är installerat men kunde inte köras",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.klautcode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.klautcode.tagline": "Pålitliga optimerade modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Besök ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Klautcode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i klautcode.json",
  ...
  "dialog.server.description": "Växla vilken Klautcode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingKlautcode": "Kontrollerar Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Kontrollerar Klautcode i {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Uppdaterar Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Uppdaterar Klautcode i {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Uppdatera Klautcode i {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Uppdatera Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode är redo i {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode är redo.",
  "wsl.onboarding.installKlautcodeIn": "Installera Klautcode i {{distro}}.",
  "wsl.onboarding.installKlautcode": "Installera Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Klautcode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Klautcode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Klautcode igen.",
  ...
  "help.tabs.introduction": "Klautcode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Klautcode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Klautcode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (klautcode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Klautcode stöder inte MCP-autentisering ännu.',
  ...
  "session.followupDock.delete": "Ta bort",
  ...
  "session.title.regenerate": "Generera om titel",
  "session.title.regenerated": "Titel genererad på nytt",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Klautcode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Klautcode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Klautcode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Klautcode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Klautcodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Klautcode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Klautcode.",
  "settings.updates.toast.missingArtifacts": "Den senaste utgåvan har ännu ingen uppdatering för denna plattform.",
