export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Klautcode",
  "desktop.recovery.terminated": "توقفت نافذة Klautcode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Klautcode لا يستجيب",
  ...
  "desktop.wsl.error.installKlautcode": "فشل تثبيت Klautcode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.klautcodeMissing": "klautcode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Klautcode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "agent.mode.multitask": "متعدد المهام",
  ...
  "dialog.provider.klautcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.klautcode.tagline": "نماذج موثوقة ومحسنة",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Klautcode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "يمنحك Klautcode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Klautcode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في klautcode.json",
  ...
  "dialog.server.description": "تبديل خادم Klautcode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingKlautcode": "جارٍ التحقق من Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "جارٍ التحقق من Klautcode في {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "جارٍ تحديث Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "جارٍ تحديث Klautcode في {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "حدّث Klautcode في {{distro}}.",
  "wsl.onboarding.updateKlautcode": "تحديث Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode جاهز في {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode جاهز.",
  "wsl.onboarding.installKlautcodeIn": "ثبّت Klautcode في {{distro}}.",
  "wsl.onboarding.installKlautcode": "تثبيت Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Klautcode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Klautcode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Klautcode.",
  ...
  "help.tabs.introduction": "أصبح Klautcode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Klautcode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Klautcode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (klautcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Klautcode لا يدعم مصادقة MCP بعد.',
  ...
  "session.followupDock.delegated.zero": "Delegated {{count}} messages to the coordinator",
  "session.followupDock.delegated.two": "Delegated {{count}} messages to the coordinator",
  ...
  "session.followupDock.delegateLaunched.zero": "Coordinator launched {{count}} subagents",
  "session.followupDock.delegateLaunched.two": "Coordinator launched {{count}} subagents",
  ...
  "session.title.regenerate": "إعادة توليد العنوان",
  "session.title.regenerated": "تمت إعادة توليد العنوان",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Klautcode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Klautcode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Klautcode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Klautcode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Klautcode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Klautcode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Klautcode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Klautcode.",
  "settings.updates.toast.missingArtifacts": "لا يوجد تحديث لهذه المنصة في أحدث إصدار بعد.",
  ...
  "settings.import.opencode.sessions.zero": "{{count}} chats",
  "settings.import.opencode.sessions.two": "{{count}} chats",
