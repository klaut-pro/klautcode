export const dict = {
  ...
  "dialog.provider.klautcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.klautcode.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.klautcodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.klautcodeZen.visit.prefix": "Besøg ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Klautcode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i klautcode.json",
  ...
  "dialog.server.description": "Skift hvilken Klautcode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingKlautcode": "Tjekker Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Tjekker Klautcode i {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Opdaterer Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Opdaterer Klautcode i {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Opdater Klautcode i {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Opdater Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Klautcode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Klautcode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Klautcode igen.",
  ...
  "toast.update.description": "En ny version af Klautcode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Klautcode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (klautcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Klautcode understøtter ikke MCP-godkendelse endnu.',
  ...
  "session.title.regenerate": "Generér titel igen",
  "session.title.regenerated": "Titel genereret igen",
  ...
  "sidebar.gettingStarted.line1": "Klautcode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Klautcode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Klautcode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Klautcode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Klautcode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Klautcodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Klautcode starter",
  ...
  "desktop.recovery.loadFailed": "Klautcode kunne ikke indlæses",
  "desktop.recovery.terminated": "Klautcode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installKlautcode": "Installationen af Klautcode mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.klautcodeMissing": "klautcode er ikke installeret i denne distribution",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode er installeret, men kunne ikke køre",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Klautcode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Klautcode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
