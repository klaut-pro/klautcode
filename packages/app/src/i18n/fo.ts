export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Skjøl",
  ...
  "desktop.menu.ariaLabel": "Klautcode valmynd",
  ...
  "desktop.recovery.loadFailed": "Klautcode miseydnaðist at heinta",
  "desktop.recovery.terminated": "Klautcode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Klautcode svarar ikki",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.klautcodeMissing": "klautcode er ikki sett upp í hesi distro",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "agent.mode.multitask": "fleirkoyrsla",
  ...
  "dialog.provider.klautcode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.klautcode.tagline": "Álítandi optimerað modell",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.klautcodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.klautcodeZen.visit.prefix": "Vitja ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Klautcode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í klautcode.json",
  ...
  "dialog.server.description": "Skift hvønn Klautcode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingKlautcode": "Kanna Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Kanna Klautcode í {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Dagføring Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Dagføring Klautcode í {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Dagfør Klautcode í {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Dagfør Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode er klárt í {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode er klárt.",
  "wsl.onboarding.installKlautcodeIn": "Set Klautcode upp í {{distro}}.",
  "wsl.onboarding.installKlautcode": "Set upp Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Klautcode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Klautcode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Klautcode aftur.",
  ...
  "help.tabs.introduction": "Klautcode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Klautcode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Klautcode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (klautcode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Klautcode stuðlar ikki MCP sannroynd enn.',
  ...
  "session.followupDock.delete": "Sletta",
  ...
  "session.title.regenerate": "Endurnýggja heitið",
  "session.title.regenerated": "Heitið endurnýggjað",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Klautcode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Klautcode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Klautcode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Klautcode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Klautcode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Klautcode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Klautcode byrjar",
