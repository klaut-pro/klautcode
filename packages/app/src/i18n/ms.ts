export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Klautcode",
  ...
  "desktop.recovery.loadFailed": "Klautcode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Klautcode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Klautcode tidak memberi respons",
  ...
  "desktop.wsl.error.installKlautcode": "Pemasangan Klautcode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.klautcodeMissing": "klautcode tidak dipasang dalam distro ini",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Klautcode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "agent.mode.multitask": "multitugas",
  ...
  "dialog.provider.klautcode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.klautcode.tagline": "Model dioptimumkan yang boleh dipercayai",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Layari",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Klautcode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam klautcode.json",
  ...
  "dialog.server.description": "Tukar pelayan Klautcode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingKlautcode": "Sedang menyemak Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Sedang menyemak Klautcode dalam {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Sedang mengemas kini Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Sedang mengemas kini Klautcode dalam {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Kemas kini Klautcode dalam {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Kemas kini Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode sedia digunakan.",
  "wsl.onboarding.installKlautcodeIn": "Pasang Klautcode dalam {{distro}}.",
  "wsl.onboarding.installKlautcode": "Pasang Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Klautcode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Klautcode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Klautcode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Klautcode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (klautcode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Klautcode belum menyokong pengesahan MCP.',
  ...
  "session.followupDock.delete": "Padam",
  ...
  "session.title.regenerate": "Jana semula tajuk",
  "session.title.regenerated": "Tajuk dijana semula",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Klautcode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Klautcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Klautcode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Klautcode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Klautcode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Klautcode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Klautcode.",
  "settings.updates.toast.missingArtifacts": "Versi terkini belum mempunyai kemas kini untuk platform ini.",
