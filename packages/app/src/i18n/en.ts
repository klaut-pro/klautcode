...
export const dict = {
  ...
  "dialog.provider.klautcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.klautcode.tagline": "Reliable optimized models",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Klautcode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.klautcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.klautcodeZen.visit.prefix": "Visit ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Klautcode.",
  ...
  "dialog.plugins.empty": "Plugins configured in klautcode.json",
  ...
  "dialog.server.description": "Switch which Klautcode server this app connects to.",
  ...
  "wsl.onboarding.checkingKlautcode": "Checking Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Checking Klautcode in {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Updating Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Updating Klautcode in {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Update Klautcode in {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Update Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode is ready in {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode is ready.",
  "wsl.onboarding.installKlautcodeIn": "Install Klautcode in {{distro}}.",
  "wsl.onboarding.installKlautcode": "Install Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Klautcode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Klautcode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "dialog.importOpencode.description":
    "We found {{count}} projects from an existing opencode installation. Import them to keep your chats.",
  ...
  "toast.update.description": "A new version of Klautcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Klautcode team",
  ...
  "error.chain.checkConfig": "Check your config (klautcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Klautcode does not support MCP authentication yet.',
  ...
  "session.title.regenerate": "Regenerate title",
  "session.title.regenerated": "Title regenerated",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Klautcode server inside WSL on Windows.",

  "settings.import.opencode.title": "Import from opencode",
  "settings.import.opencode.description":
    "Import projects and chats from an existing opencode instance stored in an opencode.db database.",
  ...
  "settings.import.opencode.empty":
    "No opencode data found in {{directory}}. Choose the folder that contains the opencode.db file of your opencode instance.",
  ...
  "settings.general.row.language.description": "Change the display language for Klautcode",
  ...
  "settings.general.row.appearance.description": "Customise how Klautcode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Klautcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Klautcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Klautcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Klautcode.",
  "settings.updates.toast.missingArtifacts": "The latest release has no update for this platform yet.",
  ...
  "designMode.notePlaceholder": "Add a note for this element…",
  ...
  "designMode.hint.main": "Click elements to annotate, type a note, drag to draw",
