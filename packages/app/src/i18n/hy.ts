export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Klautcode մենյու",
  ...
  "desktop.recovery.loadFailed": "Klautcode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Klautcode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Klautcode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.klautcodeMissing": "klautcode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "agent.mode.multitask": "բազմախնդրություն",
  ...
  "dialog.provider.klautcode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.klautcode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Klautcode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Klautcode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Klautcode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են klautcode.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Klautcode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingKlautcode": "Ստուգում է Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Ստուգում է Klautcode-ը {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Թարմացվում է Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Թարմացվում է Klautcode-ը {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Թարմացնել Klautcode-ը {{distro}}-ում։",
  "wsl.onboarding.updateKlautcode": "Թարմացնել Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.klautcodeReady": "Klautcode պատրաստ է։",
  "wsl.onboarding.installKlautcodeIn": "Տեղադրեք Klautcode-ը {{distro}}-ում։",
  "wsl.onboarding.installKlautcode": "Տեղադրեք Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Klautcode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Klautcode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Klautcode։",
  ...
  "help.tabs.introduction": "Klautcode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Klautcode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Klautcode թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (klautcode.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Klautcode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "session.followupDock.delete": "Ջնջել",
  ...
  "session.title.regenerate": "Նորից ստեղծել վերնագիրը",
  "session.title.regenerated": "Վերնագիրը նորից ստեղծվել է",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Klautcode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Klautcode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Klautcode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Klautcode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Klautcode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Klautcode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Klautcode-ի վերջին տարբերակը։",
  "settings.updates.toast.missingArtifacts": "Վերջին թողարկումը դեռևս թարմացում չունի այս հարթակի համար։",
