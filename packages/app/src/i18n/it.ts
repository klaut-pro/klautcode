export const dict = {
  ...
  "agent.mode.multitask": "multitasking",
  ...
  "dialog.provider.klautcode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.klautcode.tagline": "Modelli affidabili e ottimizzati",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.klautcodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.klautcodeZen.visit.prefix": "Visita ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Klautcode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in klautcode.json",
  ...
  "dialog.server.description": "Cambia il server Klautcode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingKlautcode": "Controllo Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Controllo Klautcode in {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Aggiornamento Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Aggiornamento Klautcode in {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Aggiorna Klautcode in {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Aggiorna Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode è pronto in {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode è pronto.",
  "wsl.onboarding.installKlautcodeIn": "Installa Klautcode in {{distro}}.",
  "wsl.onboarding.installKlautcode": "Installa Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Klautcode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Klautcode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Klautcode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Klautcode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (klautcode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Klautcode non supporta ancora l\'autenticazione MCP.',
  ...
  "session.followupDock.delete": "Elimina",
  ...
  "session.title.regenerate": "Rigenera titolo",
  "session.title.regenerated": "Titolo rigenerato",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Klautcode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Klautcode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Klautcode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Klautcode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Klautcode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Klautcode",
  ...
  "settings.updates.toast.latest.title": "Klautcode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Klautcode.",
  "settings.updates.toast.missingArtifacts": "L'ultima versione non ha ancora un aggiornamento per questa piattaforma.",
  ...
  "desktop.menu.documentation": "Documentazione di Klautcode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Klautcode",
  "desktop.recovery.terminated": "La finestra di Klautcode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Klautcode non risponde",
  ...
  "desktop.wsl.error.installKlautcode": "Installazione di Klautcode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.klautcodeMissing": "klautcode non è installato in questa distribuzione",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Klautcode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
