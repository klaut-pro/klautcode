export const dict = {
  ...
  "desktop.menu.documentation": "Klautcode Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Klautcode μενού",
  ...
  "desktop.recovery.loadFailed": "Klautcode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Klautcode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Klautcode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installKlautcode": "Klautcode η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.klautcodeMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.klautcodeCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Klautcode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "agent.mode.multitask": "πολυδιεργασία",
  ...
  "dialog.provider.klautcode.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.klautcode.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Klautcode.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο klautcode.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Klautcode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingKlautcode": "Έλεγχος Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Έλεγχος Klautcode σε {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Ενημέρωση Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Ενημέρωση Klautcode σε {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Ενημέρωση Klautcode σε {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Ενημέρωση Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode είναι έτοιμο.",
  "wsl.onboarding.installKlautcodeIn": "Εγκατάσταση του Klautcode στο {{distro}}.",
  "wsl.onboarding.installKlautcode": "Εγκατάσταση Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Klautcode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Klautcode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Klautcode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Klautcode",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (klautcode.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Klautcode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "session.followupDock.delete": "Διαγραφή",
  ...
  "session.title.regenerate": "Αναδημιουργία τίτλου",
  "session.title.regenerated": "Ο τίτλος αναδημιουργήθηκε",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Klautcode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Klautcode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Klautcode",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Klautcode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Klautcode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Klautcode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Klautcode",
