export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Klautcode",
  ...
  "desktop.menu.ariaLabel": "Meniu Klautcode",
  ...
  "desktop.recovery.loadFailed": "Klautcode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Klautcode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Klautcode nu răspunde",
  ...
  "desktop.wsl.error.installKlautcode": "Instalarea Klautcode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.klautcodeMissing": "klautcode nu este instalat în această distribuție",
  "desktop.wsl.error.klautcodeCannotRun": "klautcode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Klautcode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.klautcode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.klautcode.tagline": "Modele optimizate, fiabile",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.klautcodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.klautcodeZen.visit.prefix": "Vizitează",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Klautcode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în klautcode.json",
  ...
  "dialog.server.description": "Schimbă serverul Klautcode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingKlautcode": "Se verifică Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Se verifică Klautcode în {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Se actualizează Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Se actualizează Klautcode în {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Actualizează Klautcode în {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Actualizează Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode este gata în {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode este gata.",
  "wsl.onboarding.installKlautcodeIn": "Instalează Klautcode în {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instalează Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Klautcode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Klautcode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Klautcode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (klautcode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Klautcode nu suportă încă autentificarea MCP.',
  ...
  "session.followupDock.delete": "Șterge",
  ...
  "session.title.regenerate": "Regenerează titlul",
  "session.title.regenerated": "Titlu regenerat",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Klautcode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Klautcode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Klautcode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Klautcode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Klautcode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Klautcode",
