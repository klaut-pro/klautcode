export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Klautcode",
  ...
  "desktop.menu.ariaLabel": "Menuja Klautcode",
  ...
  "desktop.recovery.loadFailed": "Klautcode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Klautcode u mbyll papritur",
  "desktop.recovery.unresponsive": "Klautcode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installKlautcode": "Instalimi i Klautcode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.klautcodeMissing": "Klautcode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.klautcodeCannotRun": "Klautcode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Klautcode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "agent.mode.multitask": "shumëdetyrësh",
  ...
  "dialog.provider.klautcode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.klautcode.tagline": "Modele të besueshme të optimizuara",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Klautcode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në klautcode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Klautcode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingKlautcode": "Po kontrollon Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Po kontrollon Klautcode në {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Klautcode po përditësohet...",
  "wsl.onboarding.updatingKlautcodeIn": "Po përditëson Klautcode në {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Përditëso Klautcode në {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Përditëso Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode është gati në {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode është gati.",
  "wsl.onboarding.installKlautcodeIn": "Instaloni Klautcode në {{distro}}.",
  "wsl.onboarding.installKlautcode": "Instaloni Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Klautcode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Klautcode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Klautcode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (klautcode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Klautcode nuk e mbështet ende vërtetimin MCP.',
  ...
  "session.followupDock.delete": "Fshi",
  ...
  "session.title.regenerate": "Rigjenero titullin",
  "session.title.regenerated": "Titulli u rigjenerua",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Klautcode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Klautcode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Klautcode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Klautcode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Klautcode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Klautcode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Klautcode.",
  "settings.updates.toast.missingArtifacts": "Versioni më i ri ende nuk ka një përditësim për këtë platformë.",
