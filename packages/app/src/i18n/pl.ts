export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Klautcode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Klautcode",
  "desktop.recovery.terminated": "Okno Klautcode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Klautcode nie odpowiada",
  ...
  "desktop.wsl.error.installKlautcode": "Nie udało się zainstalować Klautcode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.klautcodeMissing": "Program klautcode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.klautcodeCannotRun": "Program klautcode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.klautcodeNotInstalled": "Klautcode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Klautcode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "agent.mode.multitask": "wielozadaniowy",
  ...
  "dialog.provider.klautcode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.klautcode.tagline": "Niezawodne, zoptymalizowane modele",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Klautcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Klautcode.",
  ...
  "provider.connect.klautcodeZen.line1":
    "Klautcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.klautcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.klautcodeZen.visit.link": "code.klaut.pro/zen",
  "provider.connect.klautcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Klautcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Klautcode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku klautcode.json",
  ...
  "dialog.server.description": "Przełącz serwer Klautcode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingKlautcode": "Sprawdzanie Klautcode...",
  "wsl.onboarding.checkingKlautcodeIn": "Sprawdzanie Klautcode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingKlautcode": "Aktualizowanie Klautcode...",
  "wsl.onboarding.updatingKlautcodeIn": "Aktualizowanie Klautcode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateKlautcodeIn": "Zaktualizuj Klautcode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateKlautcode": "Zaktualizuj Klautcode",
  "wsl.onboarding.klautcodeReadyIn": "Klautcode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.klautcodeReady": "Klautcode jest gotowy.",
  "wsl.onboarding.installKlautcodeIn": "Zainstaluj Klautcode w dystrybucji {{distro}}.",
  "wsl.onboarding.installKlautcode": "Zainstaluj Klautcode",
  ...
  "wsl.onboarding.distroStatus.klautcodeMissing": "Klautcode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Klautcode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Klautcode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Klautcode.",
  ...
  "help.tabs.introduction": "Klautcode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Klautcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Klautcode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (klautcode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Klautcode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "session.title.regenerate": "Wygeneruj ponownie tytuł",
  "session.title.regenerated": "Tytuł wygenerowany ponownie",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Klautcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Klautcode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Klautcode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Klautcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Klautcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Klautcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Klautcode",
