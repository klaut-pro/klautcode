...
import { Session } from "@klautcode/sdk/v2/client"
...
import { useTheme, type ColorScheme } from "@klautcode/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const updateVersion = () => readyUpdateVersion(platform.updater?.state())
                    ...
                    <div class="relative flex-1 min-h-0">
                      ...
                      >
                        ...
                        <div
                          ...
                          class="size-full flex flex-col py-1 gap-2 overflow-y-auto no-scrollbar [overflow-anchor:none]"
                        >
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://code.klaut.pro/desktop-feedback")}
      renderPanel={() =>
