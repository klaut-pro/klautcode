...
import { Accordion } from "@klautcode/ui/accordion"
import { Button } from "@klautcode/ui/button"
import { Card } from "@klautcode/ui/card"
import {
  ContextToolGroup,
  Message,
  MessageDivider,
  ...
  partDefaultOpen,
  type UserActions,
} from "@klautcode/session-ui/message-part"
import { DiffChanges } from "@klautcode/ui/diff-changes"
...
import { Dialog } from "@klautcode/ui/dialog"
import { DialogFooter, DialogHeader, DialogTitleGroup, DialogV2 } from "@klautcode/ui/v2/dialog-v2"
import { InlineInput } from "@klautcode/ui/inline-input"
import { ButtonV2 } from "@klautcode/ui/v2/button-v2"
import { SessionRetry } from "@klautcode/session-ui/session-retry"
...
import type {
  ...
  ToolPart,
  UserMessage,
} from "@klautcode/sdk/v2"
import { showToast } from "@/utils/toast"
import { downloadSessionExport, fetchSessionExport, sessionExportFilename } from "@/utils/session-export"
import { getDirectory, getFilename } from "@klautcode/core/util/path"
import { Popover as KobaltePopover } from "@kobalte/core/popover"
import { normalize } from "@klautcode/session-ui/session-diff"
import { useFileComponent } from "@klautcode/ui/context/file"
                ...
                <div class="flex items-center min-w-0 flex-1 w-full">
                  <Show when={parentID()}>
                    <button
                      ...
                      class="min-w-0 max-w-[40%] truncate pl-2 text-(--font-size-base) font-[530] leading-4 tracking-[-0.04px] text-v2-text-text-faint transition-colors hover:text-v2-text-text-muted"
                    ...
                    <span
                      ...
                      class="-translate-y-[0.5px] pl-2 pr-1 text-(--font-size-x-small) font-medium text-v2-text-text-faint"
                      aria-hidden="true"
                    >
                      /
                    </span>
                  ...
                  <Show when={childTitle() || title.editing}>
                    <Show
                      ...
                      fallback={
                        <h1
                          ...
                          classList={{
                            "truncate text-(--font-size-base) font-[530] leading-4 tracking-[-0.04px] text-v2-text-text-base": true,
                    ...
                    >
                      <InlineInput
                        ...
                        classList={{
                          "block text-(--font-size-base) font-[530] leading-4 tracking-[-0.04px] text-v2-text-text-base": true,
                          ...
                          >
                            ...
                            >
                              <div class="flex w-full flex-col gap-1.5 px-0.5 pt-0.5">
                                <div class="select-none text-(--font-size-base) font-[530] leading-none tracking-[-0.04px] text-v2-text-text-base [font-variation-settings:'slnt'_0]">
                                  {language.t("session.share.popover.title")}
                                </div>
                                <div class="select-none text-(--font-size-base) font-[440] leading-5 tracking-[-0.04px] text-v2-text-text-muted [font-variation-settings:'slnt'_0]">
                                  {shareUrl()
                                    ? language.t("session.share.popover.description.shared")
                                    : language.t("session.share.popover.description.unshared")}
                                </div>
                              ...
                              <div class="flex w-full flex-col gap-2">
                                ...
                                >
                                  <div class="flex flex-col gap-2">
                                    ...
                                    >
                                      <div
                                        class="min-w-0 flex-1 truncate select-text cursor-text text-(--font-size-base) font-[440] leading-5 tracking-[-0.04px] text-v2-text-text-base [font-variation-settings:'slnt'_0]"
