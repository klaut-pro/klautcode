import type { FilePart, Project, UserMessage, VcsFileDiff } from "@klautcode/sdk/v2"
...
import type { SessionReviewLineComment } from "@klautcode/session-ui/session-review"
...
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@klautcode/ui/scroll-view"
import { Tabs } from "@klautcode/ui/tabs"
import { ButtonV2 } from "@klautcode/ui/v2/button-v2"
import { createAutoScroll } from "@klautcode/ui/hooks"
...
import { base64Encode, checksum } from "@klautcode/core/util/encode"
...
import { SessionReviewV2SidebarToggle } from "@klautcode/session-ui/v2/session-review-v2"
