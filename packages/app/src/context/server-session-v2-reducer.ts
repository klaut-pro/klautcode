import type { KlautcodeEvent, SessionMessageInfo, SessionPendingMessage } from "@klautcode/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: KlautcodeEvent): V2SessionReduction | undefined => {
