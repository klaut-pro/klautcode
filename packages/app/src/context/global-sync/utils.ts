...
import type { Agent, PermissionRequest, Project, Provider, ProviderListResponse } from "@klautcode/sdk/v2/client"
import type { Project as CurrentProject } from "@klautcode/client/promise"
