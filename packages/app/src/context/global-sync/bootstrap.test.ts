...
import type { Config, KlautcodeClient, Project } from "@klautcode/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@klautcode/client/promise"
