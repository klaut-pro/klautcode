import type { SessionApi } from "@klautcode/client/promise"
...
export async function loadRootSessionsV1(input: { client: KlautcodeClient; directory: string; limit: number }) {
  try {
