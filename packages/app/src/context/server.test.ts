  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://klautcode.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://klautcode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://klautcode.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://klautcode.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://klautcode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://klautcode.example.com"),
      ),
    ).toEqual({
