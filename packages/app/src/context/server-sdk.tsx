import type { KlautcodeEvent } from "@klautcode/client/promise"
import type { Event } from "@klautcode/sdk/v2/client"
...
export type ServerEvent = Event & { current?: KlautcodeEvent }
...
export function adaptServerEvent(event: KlautcodeEvent): ServerEvent {
...
function currentDelta(event: KlautcodeEvent | undefined): CurrentDelta | undefined {
  if (
