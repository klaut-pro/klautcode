...
import { AbsolutePath, type DeepMutable } from "@klautcode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".klautcode", "plans", "*.md")]: "allow",
