...
import { EventSequenceTable, EventTable } from "@klautcode/core/event/sql"
...
import { WorkspaceEvent } from "@klautcode/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        KLAUTCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        KLAUTCODE_WORKSPACE_ID: config.id,
        KLAUTCODE_EXPERIMENTAL_WORKSPACES: "true",
