...
const USER_AGENT = `klautcode/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const klautcodeProjectID = input.model.providerID.startsWith("klautcode")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("klautcode")
        ? {
            ...(klautcodeProjectID ? { "x-klautcode-project": klautcodeProjectID } : {}),
            "x-klautcode-session": input.sessionID,
            "x-klautcode-request": input.user.id,
            "x-klautcode-client": input.flags.client,
