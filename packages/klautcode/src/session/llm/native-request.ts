import type { JsonSchema, LLMRequest, ProviderMetadata } from "@klautcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@klautcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @klautcode/llm request objects from klautcode's session/AI SDK-shaped data.
  return LLM.request({
