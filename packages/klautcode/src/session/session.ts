...
import { Slug } from "@klautcode/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@klautcode/llm"
...
import { locationServiceMapLayer } from "@klautcode/core/location-services"
...
import { PartTable, SessionTable } from "@klautcode/core/session/sql"
...
import { NonNegativeInt, optional } from "@klautcode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".klautcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/Session") {}
