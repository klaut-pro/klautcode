...
import { llmClient } from "@klautcode/core/effect/app-node-platform"
...
import type { LLMEvent } from "@klautcode/llm"
import { LLMClient } from "@klautcode/llm/route"
import type { LLMClientService } from "@klautcode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via klautcode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @klautcode/llm. It
