...
import { buildPrompt } from "@klautcode/core/session/compaction"
import { SessionCompactionEvent } from "@klautcode/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/SessionCompaction") {}
