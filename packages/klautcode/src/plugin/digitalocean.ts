import type { Hooks, PluginInput } from "@klautcode/plugin"
import type { Model } from "@klautcode/sdk/v2"
import { InstallationVersion } from "@klautcode/core/installation/version"
import { OauthCallbackPage } from "@klautcode/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Klautcode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
