...
import { ProjectDirectoryTable, ProjectTable } from "@klautcode/core/project/sql"
import { ProjectDirectories } from "@klautcode/core/project/directories"
...
import { which } from "@klautcode/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.KLAUTCODE_FAKE_VCS)
