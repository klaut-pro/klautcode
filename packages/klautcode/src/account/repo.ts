...
import { AccountStateTable, AccountTable } from "@klautcode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/AccountRepo") {}
