...
import type * as SDK from "@klautcode/sdk/v2"
...
import { SessionShareTable } from "@klautcode/core/share/sql"
...
const disabled = process.env["KLAUTCODE_DISABLE_SHARE"] === "true" || process.env["KLAUTCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/ShareNext") {}
