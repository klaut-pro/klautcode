...
import { normalizePromptContent } from "@klautcode/tui/editor"
...
import { KLAUTCODE_BASE_MODE, useBindings } from "@klautcode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Klautcode" } satisfies SlashOption,
    ]
