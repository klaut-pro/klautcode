...
//
// The saved variant persists across sessions in ~/.local/state/klautcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@klautcode/RunVariant") {}
