...
import type { Event, GlobalEvent, KlautcodeClient } from "@klautcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@klautcode/RunStreamTransport") {}
