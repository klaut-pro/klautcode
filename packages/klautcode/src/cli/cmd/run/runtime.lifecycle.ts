...
import { openEditor } from "@klautcode/tui/editor"
import { registerKlautcodeKeymap } from "@klautcode/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerKlautcodeKeymap(keymap, renderer, input.tuiConfig)
