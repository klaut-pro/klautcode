 ...
 *   "@klautcode/ServerAuthConfig",
 *   {
 *     password: Config.string("KLAUTCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("KLAUTCODE_SERVER_USERNAME").pipe(Config.withDefault("klautcode")),
 *   },
 * ) {}
 *
