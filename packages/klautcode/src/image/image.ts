...
export class Service extends Context.Service<Service, Interface>()("@klautcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __KLAUTCODE_PHOTON_WASM_PATH?: string }).__KLAUTCODE_PHOTON_WASM_PATH =
