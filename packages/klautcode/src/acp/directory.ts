...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@klautcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@klautcode/ACPDirectory") {}
