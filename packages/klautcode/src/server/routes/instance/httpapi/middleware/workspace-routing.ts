...
>()("@klautcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@klautcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.KLAUTCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.KLAUTCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-klautcode-directory"] || process.cwd()
}
