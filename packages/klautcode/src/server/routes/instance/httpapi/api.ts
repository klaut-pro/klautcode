...
import { LocationMiddleware } from "@klautcode/server/location"
import { SessionLocationMiddleware } from "@klautcode/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("klautcode-root")
...
export const InstanceHttpApi = HttpApi.make("klautcode-instance")
...
export const KlautcodeHttpApi = HttpApi.make("klautcode")
