...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KLAUTCODE_CALLER", () => {
    process.env["KLAUTCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KLAUTCODE_CALLER", () => {
    process.env["KLAUTCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KLAUTCODE_CALLER", () => {
    process.env["KLAUTCODE_CALLER"] = "unknown"
