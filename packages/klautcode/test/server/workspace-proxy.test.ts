...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips klautcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-klautcode-directory"]).toBeUndefined()
      expect(forwarded["x-klautcode-workspace"]).toBeUndefined()
