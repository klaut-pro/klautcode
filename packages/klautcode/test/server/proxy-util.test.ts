...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips klautcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-klautcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-klautcode-directory")).toBeNull()
      expect(result.get("x-klautcode-workspace")).toBeNull()
