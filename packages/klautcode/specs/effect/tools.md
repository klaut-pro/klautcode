...
Practical reference for the current tool-migration state in `packages/klautcode`.
...
Tool tests should use the existing Effect helpers in `packages/klautcode/test/lib/effect.ts`:
