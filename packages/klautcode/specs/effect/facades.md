...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/klautcode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy klautcode service removed
