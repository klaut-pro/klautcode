...
- Effect plugins import `@klautcode/plugin/v2/effect`, not `@klautcode/core`.
- Public domain values use generated `@klautcode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@klautcode/plugin/v2/effect`.
