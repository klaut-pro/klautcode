...
export const dict = {
  ...
  "go.problem.body":
    "Klautcode deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. OpenCode Go düşük maliyetli bir aboneliktir: İlk ay $5, sonrasında ayda 10$. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için klautcode yapılandırmanızda "OpenCode Go"\'yu sağlayıcı olarak seçin.',
