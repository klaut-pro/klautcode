...
import compareVideo from "../../asset/lander/klautcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/klautcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="klautcode:auth" content={loggedin() ? "true" : "false"} />
