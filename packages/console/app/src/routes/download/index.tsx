      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://code.klaut.pro/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>code.klaut.pro/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g klautcode-ai")}>
                <code>
                  npm i -g <strong>klautcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g klautcode-ai")}>
                <code>
                  bun add -g <strong>klautcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/klautcode")}>
                <code>
                  brew install <strong>anomalyco/tap/klautcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S klautcode")}>
                <code>
                  paru -S <strong>klautcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask klautcode-desktop")}>
                <code>
                  brew install --cask <strong>klautcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
