...
import { Database, eq, and, isNull } from "@klautcode/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@klautcode/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#klautcode-go")} target="_blank" rel="noopener noreferrer">
