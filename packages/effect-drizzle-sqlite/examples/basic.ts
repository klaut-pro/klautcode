...
class Database extends Context.Service<Database, DatabaseShape>()("@klautcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@klautcode/example/UserStore") {
