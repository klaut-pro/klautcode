...
import type { EffectDrizzleSqlite } from "@klautcode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/ProjectDirectories") {}
