...
import { Event } from "@klautcode/schema/project-directories"
import { ProjectCopy } from "@klautcode/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/ProjectCopy") {}
