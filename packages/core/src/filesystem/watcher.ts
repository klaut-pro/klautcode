...
import { FileSystemWatcher } from "@klautcode/schema/filesystem-watcher"
...
declare const KLAUTCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof KLAUTCODE_LIBC === "undefined" ? undefined : KLAUTCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.KLAUTCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.KLAUTCODE_EXPERIMENTAL_FILEWATCHER)) {
