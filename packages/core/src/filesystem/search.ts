...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.KLAUTCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
