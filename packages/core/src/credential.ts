...
import { Credential } from "@klautcode/schema/credential"
import { Integration } from "@klautcode/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/Credential") {}
