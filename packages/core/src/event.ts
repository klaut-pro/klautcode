...
import type { Data, Definition, Payload } from "@klautcode/schema/event"
...
import { Durable } from "@klautcode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@klautcode/schema/event").ID
export type { Data, Definition, Payload } from "@klautcode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/Event") {}
