...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@klautcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/ToolRegistry") {}
