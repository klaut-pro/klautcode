...
import { ListAnchor } from "@klautcode/schema/session"
...
import { SessionDurable } from "@klautcode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/Session") {}
