...
import type { Plugin as PluginRuntime } from "@klautcode/plugin/v2/effect"
import { Plugin } from "@klautcode/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/Plugin") {}
