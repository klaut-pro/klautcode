...
import { Entry, FileSystem, FindInput, Match } from "@klautcode/schema/filesystem"
export { Entry, Match, Submatch } from "@klautcode/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@klautcode/v2/FileSystem") {}
