...
const icons = {
  ...
  chat: {
    viewBox: "0 0 16 16",
    body: `<path d="M1.5 3H14.5V11H6.5L3 14V11H1.5V3Z" stroke="currentColor" stroke-linejoin="round"/><path d="M4.5 6H11.5M4.5 8.5H8.5" stroke="currentColor" stroke-linecap="round"/>`,
  },
  status: {
    viewBox: "0 0 20 20",
...
const spriteID = "klautcode-v2-icon-sprite"
const symbol = (name: keyof typeof icons) => `klautcode-v2-icon-${name}`
