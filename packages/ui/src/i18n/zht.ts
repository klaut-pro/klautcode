...
export const dict = {
  ...
  "ui.messagePart.thinkingDone": "思考過程",
  ...
  "ui.tool.shell": "Shell",
  "ui.tool.shell.viewFullOutput": "檢視完整輸出",
  "ui.tool.shell.hideFullOutput": "隱藏完整輸出",
  "ui.tool.shell.fullOutputUnavailable": "完整輸出不再可用",
  "ui.tool.patch": "修補",
  "ui.tool.todos": "待辦",
  ...
  "ui.permission.allowAlwaysGlobal": "全域允許",
