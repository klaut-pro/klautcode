export const dict = {
  ...
  "ui.tool.shell.viewFullOutput": "Показать полный вывод",
  "ui.tool.shell.hideFullOutput": "Скрыть полный вывод",
  "ui.tool.shell.fullOutputUnavailable": "Полный вывод больше недоступен",
  "ui.tool.patch": "Патч",
