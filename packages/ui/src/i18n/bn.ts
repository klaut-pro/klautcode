export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Klautcode-এ সদস্যতা নিন $5/মাস থেকে শুরু করে সেরা ওপেন-সোর্স মডেলগুলিতে নির্ভরযোগ্য অ্যাক্সেসের জন্য যান৷",
  ...
  "ui.messagePart.thinking": "চিন্তা করা হচ্ছে…",
  "ui.messagePart.thinkingDone": "চিন্তার প্রক্রিয়া",
  ...
  "ui.tool.shell": "শেল",
  "ui.tool.shell.viewFullOutput": "সম্পূর্ণ আউটপুট দেখুন",
  "ui.tool.shell.hideFullOutput": "সম্পূর্ণ আউটপুট লুকান",
  "ui.tool.shell.fullOutputUnavailable": "সম্পূর্ণ আউটপুট আর উপলব্ধ নেই",
  "ui.tool.patch": "প্যাচ",
  ...
  "ui.permission.allowAlwaysGlobal": "গ্লোবালভাবে অনুমতি দিন",
