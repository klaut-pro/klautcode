export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Εγγραφείτε στο Klautcode Μετάβαση για αξιόπιστη πρόσβαση στα καλύτερα μοντέλα ανοιχτού κώδικα, ξεκινώντας από 5 $/μήνα.",
  ...
  "ui.messagePart.thinking": "Σκέψη…",
  "ui.messagePart.thinkingDone": "Διαδικασία σκέψης",
  ...
  "ui.tool.shell": "Shell",
  "ui.tool.shell.viewFullOutput": "Προβολή πλήρους εξόδου",
  "ui.tool.shell.hideFullOutput": "Απόκρυψη πλήρους εξόδου",
  "ui.tool.shell.fullOutputUnavailable": "Η πλήρης έξοδος δεν είναι πλέον διαθέσιμη",
  "ui.tool.patch": "Patch",
  ...
  "ui.permission.allowAlwaysGlobal": "Να επιτρέπεται καθολικά",
