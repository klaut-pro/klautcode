...
import { registerKlautcodeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@klautcode/sdk/v2"
...
import { KLAUTCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useKlautcodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.KLAUTCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
