...
import defaultSoundPath from "@klautcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@klautcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@klautcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@klautcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@klautcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@klautcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "klautcode"
const DEFAULT_PACK_ID = "klautcode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Klautcode Default",
  builtin: true,
  sounds: {
