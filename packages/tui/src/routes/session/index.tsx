...
import { MiniOrbs } from "../../component/mini-orbs"
...
import { KLAUTCODE_BASE_MODE, useBindings, useCommandShortcut, useKlautcodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["klautcode", "klautcode-go"])
      ...
      <Match when={!props.done}>
        <box flexDirection="row">
          ...
          <text fg={fg()} wrapMode="none">
            <span>{props.title ? "Thinking: " + props.title : "Thinking"}</span>
          </text>
        </box>
      </Match>
      <Match when={true}>
