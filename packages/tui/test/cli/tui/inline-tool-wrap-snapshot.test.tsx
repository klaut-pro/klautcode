...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "KLAUTCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/klautcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/klautcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/klautcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/klautcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const KLAUTCODE_DB|KLAUTCODE_DB|KLAUTCODE_DEV|Global\\.Path\\.data|data =" in packages/klautcode/src (115 matches)',
  },
] as const
