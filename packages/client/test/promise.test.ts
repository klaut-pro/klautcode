...
import { isSessionNotFoundError, isUnauthorizedError, Klautcode } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = Klautcode.make({ baseUrl: "http://localhost:3000" })
