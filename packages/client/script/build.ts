...
import { compile, emitEffectImported, emitPromise, write } from "@klautcode/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "KlautcodeEventEncoded",
              import: 'import type { KlautcodeEventEncoded } from "@klautcode/protocol/groups/event"',
            },
          },
        }),
