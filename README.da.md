...
brew install klaut-pro/tap/klautcode # macOS og Linux (anbefalet, altid up to date)
brew install klautcode              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
Klautcode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/klaut-pro/klautcode/releases) eller [code.klaut.pro/download](https://code.klaut.pro/download).
...
1. `$KLAUTCODE_INSTALL_DIR` - Tilpasset installationsmappe
...
Klautcode har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://code.klaut.pro/docs/agents).

### Dokumentation

For mere info om konfiguration af Klautcode, [**se vores docs**](https://code.klaut.pro/docs).

### Bidrag

Hvis du vil bidrage til Klautcode, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på Klautcode

Hvis du arbejder på et projekt der er relateret til Klautcode og bruger "klautcode" som en del af navnet; f.eks. "klautcode-dashboard" eller "klautcode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af Klautcode-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/klautcode) | [X.com](https://x.com/klautcode)
