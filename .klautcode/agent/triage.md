...
Desktop application and browser-based app issues, including `klautcode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core klautcode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Klautcode Zen, Klautcode Go, and billing issues.
