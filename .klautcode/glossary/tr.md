...
- PR #15835: https://github.com/klaut-pro/klautcode/pull/15835

## Do Not Translate (Locale Additions)

- `Klautcode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `klautcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Klautcode` in prose, `klautcode` only for exact technical identifiers
...
- Avoid changing `klautcode` to `Klautcode` inside commands, URLs, package names, or code literals
