...
- PR #13942: https://github.com/klaut-pro/klautcode/pull/13942

## Do Not Translate (Locale Additions)

- `Klautcode` (preserve casing in prose; keep `klautcode` only when it is part of commands, package names, paths, or code)
- `Klautcode Zen`
- `Klautcode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `klautcode` in prose when referring to the product name; use `Klautcode`
