...
- PR #10809: https://github.com/klaut-pro/klautcode/pull/10809
- PR #11496: https://github.com/klaut-pro/klautcode/pull/11496

## Do Not Translate (Locale Additions)

- `Klautcode` (preserve casing in prose; keep `klautcode` only in commands, package names, paths, or code)
- `Klautcode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
