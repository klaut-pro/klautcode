...
Use this folder for locale-specific translation guidance that supplements `.klautcode/agent/translator.md`.
...
- PR #12345: https://github.com/klaut-pro/klautcode/pull/12345

## Do Not Translate (Locale Additions)

- `Klautcode` (preserve casing)
